...
public class ServiceLoader {
    ...
    public <T> Class<? extends T> getServiceClass(Class<T> cls, String str) throws ClassNotFoundException {
        ClassLoader classLoader = this.loader;
        if (classLoader == null) {
            throw new ClassNotFoundException(OooOo.OooOO0O("Service class ", str, " is not available"));
        }
        Class<? extends T> cls2 = (Class<? extends T>) Class.forName(str, true, classLoader);
        if (cls2.isInterface()) {
            throw new ClassNotFoundException(OooOo.OooOO0O("Service class ", str, " is an interface"));
        }
        if (cls.isAssignableFrom(cls2)) {
            return cls2;
        }
        throw new ClassNotFoundException(OooO00o.OooOO0o("Service class ", str, " does not implement ", cls.getName()));
    }
