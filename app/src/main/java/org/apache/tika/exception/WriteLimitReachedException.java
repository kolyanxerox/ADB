...
public class WriteLimitReachedException extends SAXException {
    ...
    public String getMessage() {
        return OooOo.OooO0oO(this.writeLimit, "Your document contained more than ", " characters, and so your requested limit has been reached. To receive the full text of the document, increase your limit. (Text up to the limit is however available).");
    }
