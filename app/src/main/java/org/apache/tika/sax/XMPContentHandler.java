...
public class XMPContentHandler extends SafeContentHandler {
    ...
    public void property(String str, String str2) throws SAXException {
        String strOooOoo = OooOo.OooOoo(this.prefix, TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER, str);
        startElement(this.uri, str, strOooOoo, EMPTY_ATTRIBUTES);
        characters(str2.toCharArray(), 0, str2.length());
        endElement(this.uri, str, strOooOoo);
    }
