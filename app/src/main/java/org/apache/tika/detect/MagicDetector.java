...
public class MagicDetector implements Detector {
    ...
    private static byte[] decodeValue(String str, String str2) throws NumberFormatException {
        ...
        switch (c2) {
            ...
            case 11:
                ...
                bArr2[c] = (byte) (j & 255);
                bArr2[1] = (byte) ((j & 65280) >> 8);
                bArr2[2] = (byte) ((j & 16711680) >> 16);
                bArr2[3] = (byte) ((j & (-16777216)) >> 24);
                return bArr2;
            case 2:
            case 3:
            case 4:
            ...
            case '\b':
                ...
                bArr4[c] = (byte) ((j2 & (-16777216)) >> 24);
                bArr4[1] = (byte) ((j2 & 16711680) >> 16);
                bArr4[2] = (byte) ((j2 & 65280) >> 8);
                bArr4[3] = (byte) (j2 & 255);
                return bArr4;
            default:
                return null;
    ...
    public MediaType detect(InputStream inputStream, Metadata metadata) throws IOException {
        ...
        while (true) {
            try {
                ...
                if (i >= i2) {
                    int i3 = (this.offsetRangeEnd - i2) + this.length;
    ...
    public String toString() {
        ...
        String string2 = Arrays.toString(this.mask);
        StringBuilder sb = new StringBuilder("Magic Detection for ");
        sb.append(mediaType);
        sb.append(" looking for ");
        sb.append(length);
        sb.append(" bytes = ");
        return OooO00o.OooOOO0(sb, string, " mask = ", string2);
    }
    ...
    public MagicDetector(MediaType mediaType, byte[] bArr, byte[] bArr2, boolean z, boolean z2, int i, int i2) {
        ...
        throw new IllegalArgumentException(OooOo.OooO("Invalid offset range: [", i, ",", i2, C3034d9.i.f8179e));
    }
}
