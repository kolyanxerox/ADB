...
public abstract class StartupApiFeature {
    ...
    public static class C0825P extends StartupApiFeature {
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        try {
            return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m41of(640L)).metaData;
