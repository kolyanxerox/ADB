...
public class WebMessageAdapter implements WebMessageBoundaryInterface {
    ...
    public static WebMessageCompat webMessageCompatFromBoundaryInterface(WebMessageBoundaryInterface webMessageBoundaryInterface) {
        ...
        WebMessagePayloadBoundaryInterface webMessagePayloadBoundaryInterface = (WebMessagePayloadBoundaryInterface) o00oO0o.OooO0O0(WebMessagePayloadBoundaryInterface.class, webMessageBoundaryInterface.getMessagePayload());
    ...
    public InvocationHandler getMessagePayload() {
        ...
        return new oo000o(webMessagePayloadAdapter);
    }
