...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0512Op c0512Op = this.mOps.get(i2);
                Fragment fragment = c0512Op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "Bump nesting of " + c0512Op.mFragment + " to " + c0512Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    public void collapseOps() {
        ...
        while (size >= 0) {
            FragmentTransaction.C0512Op c0512Op = this.mOps.get(size);
            if (c0512Op.mFromExpandedOp) {
                if (c0512Op.mCmd == 8) {
                    c0512Op.mFromExpandedOp = false;
                    this.mOps.remove(size - 1);
                    size--;
                } else {
                    int i = c0512Op.mFragment.mContainerId;
                    c0512Op.mCmd = 2;
                    c0512Op.mFromExpandedOp = false;
                    for (int i2 = size - 1; i2 >= 0; i2--) {
                        FragmentTransaction.C0512Op c0512Op2 = this.mOps.get(i2);
                        if (c0512Op2.mFromExpandedOp && c0512Op2.mFragment.mContainerId == i) {
                            this.mOps.remove(i2);
                            size--;
                        }
                    }
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0512Op c0512Op = this.mOps.get(i);
            Fragment fragment = c0512Op.mFragment;
            if (fragment != null) {
            ...
            switch (c0512Op.mCmd) {
                case 1:
                    fragment.setAnimations(c0512Op.mEnterAnim, c0512Op.mExitAnim, c0512Op.mPopEnterAnim, c0512Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0512Op.mCmd);
                case 3:
                    fragment.setAnimations(c0512Op.mEnterAnim, c0512Op.mExitAnim, c0512Op.mPopEnterAnim, c0512Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0512Op.mCurrentMaxState);
                    break;
            }
        }
    }
        ...
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            ...
            switch (c0512Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0512Op.mOldMaxState);
                    break;
            }
        }
    }
    ...
    */
    public androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0512Op) r5
            int r6 = r5.mCmd
            r7 = 1
            if (r6 == r7) goto Lb6
            r8 = 2
    ...
    */
    public androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0512Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            printWriter.println(c0512Op.mFragment);
            if (z) {
                if (c0512Op.mEnterAnim != 0 || c0512Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0512Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0512Op.mExitAnim));
                }
                if (c0512Op.mPopEnterAnim != 0 || c0512Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0512Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0512Op.mPopExitAnim));
                }
            }
        }
    }
