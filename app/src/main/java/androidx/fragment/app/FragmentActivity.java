...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new OooO(this, 0));
        final int i = 0;
        addOnConfigurationChangedListener(new Consumer(this) { // from class: androidx.fragment.app.OooOO0

            /* renamed from: OooOo0o, reason: collision with root package name */
            public final /* synthetic */ FragmentActivity f15294OooOo0o;

            {
                this.f15294OooOo0o = this;
            }
            ...
            public final void accept(Object obj) {
                switch (i) {
                    case 0:
                        this.f15294OooOo0o.lambda$init$1((Configuration) obj);
                        break;
                    default:
                        this.f15294OooOo0o.lambda$init$2((Intent) obj);
                        break;
                }
            }
        });
        final int i2 = 1;
        addOnNewIntentListener(new Consumer(this) { // from class: androidx.fragment.app.OooOO0
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.OooOO0O
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f15295OooO00o.lambda$init$3(context);
            }
        });
    }
