...
class FragmentStateManager {
    ...
    public class ViewOnAttachStateChangeListenerC05091 implements View.OnAttachStateChangeListener {
        final /* synthetic */ View val$fragmentView;

        public ViewOnAttachStateChangeListenerC05091(View view) {
            view = view;
        }
    ...
    public static /* synthetic */ class C05102 {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(OooOo.OooOOOo(sb, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int i = C05102.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i != 1) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbOooOOo0 = OooOo.OooOOo0(iMin, "computeExpectedState() of ", " for ");
            sbOooOOo0.append(this.mFragment);
            Log.v("FragmentManager", sbOooOOo0.toString());
        }
        return iMin;
    }
    ...
    public void createView() throws Resources.NotFoundException {
        ...
        if (this.mFragment.mView != null) {
            ...
            Fragment fragment4 = this.mFragment;
            fragment4.mView.setTag(C0473R.id.fragment_container_view_tag, fragment4);
            if (viewGroup != null) {
                addViewToContainer();
            }
            Fragment fragment5 = this.mFragment;
            ...
            if (this.mFragment.mView.isAttachedToWindow()) {
                ...
                view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.fragment.app.FragmentStateManager.1
                    ...
                    public ViewOnAttachStateChangeListenerC05091(View view2) {
                        view = view2;
                    }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                ...
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0473R.id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
    ...
    public void resume() {
        ...
        if (focusedView != null && isFragmentViewChild(focusedView)) {
            ...
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                sb.append(zRequestFocus ? "succeeded" : C3034d9.h.f8131t);
