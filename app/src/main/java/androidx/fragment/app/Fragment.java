...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public class C048410<I> extends ActivityResultLauncher<I> {
        final /* synthetic */ ActivityResultContract val$contract;
        final /* synthetic */ AtomicReference val$ref;

        public C048410(AtomicReference atomicReference, ActivityResultContract activityResultContract) {
    ...
    public class C04852 extends OnPreAttachedListener {
        public C04852() {
        }
    ...
    public class RunnableC04863 implements Runnable {
        public RunnableC04863() {
        }
    ...
    public class RunnableC04874 implements Runnable {
        final /* synthetic */ SpecialEffectsController val$controller;

        public RunnableC04874(SpecialEffectsController specialEffectsController) {
    ...
    public class C04885 extends FragmentContainer {
        public C04885() {
        }
    ...
    public class C04896 implements LifecycleEventObserver {
        public C04896() {
        }
    ...
    public class C04907 implements Function<Void, ActivityResultRegistry> {
        public C04907() {
        }
    ...
    public class C04918 implements Function<Void, ActivityResultRegistry> {
        final /* synthetic */ ActivityResultRegistry val$registry;

        public C04918(ActivityResultRegistry activityResultRegistry) {
    ...
    public class C04929 extends OnPreAttachedListener {
        ...
        public C04929(Function function, AtomicReference atomicReference, ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
            super();
            function = function;
            atomicReference = atomicReference;
            activityResultContract = activityResultContract;
    ...
    public static abstract class OnPreAttachedListener {
        ...
        public /* synthetic */ OnPreAttachedListener(RunnableC04831 runnableC04831) {
            this();
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(ActivityResultContract<I, O> activityResultContract, Function<Void, ActivityResultRegistry> function, ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
        ...
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.9
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C04929(Function function2, AtomicReference atomicReference2, ActivityResultContract activityResultContract2, ActivityResultCallback activityResultCallback2) {
                super();
                function = function2;
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            public C048410(AtomicReference atomicReference2, ActivityResultContract activityResultContract2) {
                atomicReference = atomicReference2;
                activityResultContract = activityResultContract2;
            }
    ...
    public void callStartTransitionListener(boolean z) {
        ...
        if (z) {
            this.mHost.getHandler().post(new Runnable() { // from class: androidx.fragment.app.Fragment.4
                ...
                public RunnableC04874(SpecialEffectsController orCreateController2) {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(OooOo.OooOoo0(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new OooO0O0(this, 2));
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(String[] strArr, int i) {
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " not attached to Activity"));
        }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            throw new IllegalArgumentException(androidx.datastore.preferences.protobuf.OooO00o.OooOO0O("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    public static class SavedState implements Parcelable {
        ...
        public class C04931 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState[] newArray(int i) {
                return new SavedState[i];
            }
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) throws IllegalAccessException, java.lang.InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw new InstantiationException(OooOo.OooOO0O("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e2) {
            throw new InstantiationException(OooOo.OooOO0O("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(OooOo.OooOO0O("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(OooOo.OooOO0O("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> activityResultContract, ActivityResultRegistry activityResultRegistry, ActivityResultCallback<O> activityResultCallback) {
        return prepareCallInternal(activityResultContract, new Function<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.8
            ...
            public C04918(ActivityResultRegistry activityResultRegistry2) {
