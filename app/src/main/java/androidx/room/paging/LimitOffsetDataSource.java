...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    public LimitOffsetDataSource(RoomDatabase roomDatabase, RoomSQLiteQuery roomSQLiteQuery, boolean z, String... strArr) throws SQLException {
    ...
    public List<T> loadRange(int i, int i2) throws SQLException {
