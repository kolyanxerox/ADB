...
public class TableInfo {
    ...
    public static class Column {
        ...
        public String toString() {
            ...
            return OooOo.OooOOOo(sb, this.defaultValue, "'}");
        }
    ...
    public static class ForeignKey {
        ...
        public int hashCode() {
            return this.referenceColumnNames.hashCode() + ((this.columnNames.hashCode() + OooO00o.OooO0O0(OooO00o.OooO0O0(this.referenceTable.hashCode() * 31, 31, this.onDelete), 31, this.onUpdate)) * 31);
        }
    ...
    private static List<ForeignKeyWithSequence> readForeignKeyFieldMappings(Cursor cursor) {
        int columnIndex = cursor.getColumnIndex(C3007ch.f7763x);
    ...
    private static Set<ForeignKey> readForeignKeys(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = cursorQuery.getColumnIndex(C3007ch.f7763x);
            int columnIndex2 = cursorQuery.getColumnIndex("seq");
            int columnIndex3 = cursorQuery.getColumnIndex(C3037dc.f8241Q);
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = cursorQuery.getColumnIndex("name");
            int columnIndex2 = cursorQuery.getColumnIndex(C3037dc.f8261p);
