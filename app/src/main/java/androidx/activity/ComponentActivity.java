...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    public class C00091 extends ActivityResultRegistry {
        ...
        public class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                C00091.this.dispatchResult(i, synchronousResult.getValue());
            }
        }
        ...
        public class AnonymousClass2 implements Runnable {
            ...
            @Override // java.lang.Runnable
            public void run() {
                C00091.this.dispatchResult(i, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, sendIntentException));
            }
        }
        ...
        public <I, O> void onLaunch(int i, ActivityResultContract<I, O> activityResultContract, I i2, ActivityOptionsCompat activityOptionsCompat) {
            ...
            if (synchronousResult != null) {
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.1.1
                    ...
                    public AnonymousClass1(int i4, ActivityResultContract.SynchronousResult synchronousResult2) {
                        i = i4;
            ...
            if (!ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST.equals(intentCreateIntent.getAction())) {
                ActivityCompat.startActivityForResult(componentActivity, intentCreateIntent, i4, bundle2);
                return;
            }
            ...
            try {
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.1.2
                        ...
                        public AnonymousClass2(int i32, IntentSender.SendIntentException e2) {
                            i = i32;
    ...
    public class C00102 implements LifecycleEventObserver {
        public C00102() {
        }
    ...
    public class C00113 implements LifecycleEventObserver {
        public C00113() {
        }
    ...
    public class C00124 implements LifecycleEventObserver {
        public C00124() {
        }
    ...
    public class RunnableC00135 implements Runnable {
        public RunnableC00135() {
        }
    ...
    public class C00146 implements LifecycleEventObserver {
        public C00146() {
        }
    ...
    public class ReportFullyDrawnExecutorApi16Impl implements ReportFullyDrawnExecutor, ViewTreeObserver.OnDrawListener, Runnable {
        ...
        public void execute(Runnable runnable) {
            ...
            if (!this.mOnDrawScheduled) {
                decorView.postOnAnimation(new OooO0o(this, 0));
    ...
    public ComponentActivity() {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new OooO0o(this, 1));
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorCreateFullyDrawnExecutor, new o00O0Oo.OooO0O0() { // from class: androidx.activity.OooO00o
            @Override // o00O0Oo.OooO0O0
            public final Object invoke() {
                return this.f15162OooOo0O.lambda$new$0();
            }
        });
        ...
        this.mActivityResultRegistry = new ActivityResultRegistry() { // from class: androidx.activity.ComponentActivity.1
            ...
            @Override // androidx.activity.result.ActivityResultRegistry
            public <I, O> void onLaunch(int i4, ActivityResultContract<I, O> activityResultContract, I i2, ActivityOptionsCompat activityOptionsCompat) {
                Bundle bundle;
                int i32;
                ComponentActivity componentActivity = ComponentActivity.this;
                ...
                if (synchronousResult2 != null) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.1.1
                        ...
                        public AnonymousClass1(int i42, ActivityResultContract.SynchronousResult synchronousResult22) {
                            i = i42;
                ...
                if (ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS.equals(intentCreateIntent.getAction())) {
                    ...
                    ActivityCompat.requestPermissions(componentActivity, stringArrayExtra, i42);
                    return;
                }
                if (!ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST.equals(intentCreateIntent.getAction())) {
                    ActivityCompat.startActivityForResult(componentActivity, intentCreateIntent, i42, bundle2);
                    return;
                }
                IntentSenderRequest intentSenderRequest = (IntentSenderRequest) intentCreateIntent.getParcelableExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_INTENT_SENDER_REQUEST);
                try {
                    i32 = i42;
                    try {
                        ActivityCompat.startIntentSenderForResult(componentActivity, intentSenderRequest.getIntentSender(), i32, intentSenderRequest.getFillInIntent(), intentSenderRequest.getFlagsMask(), intentSenderRequest.getFlagsValues(), 0, bundle2);
                    } catch (IntentSender.SendIntentException e) {
                        e2 = e;
                        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.1.2
                            final /* synthetic */ IntentSender.SendIntentException val$e;
                            ...
                            public AnonymousClass2(int i322, IntentSender.SendIntentException e2) {
                                i = i322;
                                sendIntentException = e2;
                            }
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.OooO0O0
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.f15163OooO00o.lambda$new$1();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.OooO0OO
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f15164OooO00o.lambda$new$2(context);
            }
        });
    }
    ...
    public /* synthetic */ OooOo lambda$new$0() {
        reportFullyDrawn();
        return null;
    }
