...
public abstract class ActivityResultRegistry {
    ...
    private int generateRandomNumber() {
        o00oO0o o00oo0o = o0Oo0oo.f32797OooOo0O;
        int iNextInt = o0Oo0oo.f32797OooOo0O.OooO0o().nextInt(2147418112);
        while (true) {
            int i = iNextInt + 65536;
            if (!this.mRcToKey.containsKey(Integer.valueOf(i))) {
                return i;
            }
            o00oO0o o00oo0o2 = o0Oo0oo.f32797OooOo0O;
            iNextInt = o0Oo0oo.f32797OooOo0O.OooO0o().nextInt(2147418112);
        }
    }
    ...
    public final void unregister(String str) {
        ...
        if (this.mParsedPendingResults.containsKey(str)) {
            StringBuilder sbOooOoO0 = OooOo.OooOoO0("Dropping pending result for request ", str, ": ");
            sbOooOoO0.append(this.mParsedPendingResults.get(str));
            Log.w(LOG_TAG, sbOooOoO0.toString());
            this.mParsedPendingResults.remove(str);
        }
        if (this.mPendingResults.containsKey(str)) {
            StringBuilder sbOooOoO02 = OooOo.OooOoO0("Dropping pending result for request ", str, ": ");
            sbOooOoO02.append(this.mPendingResults.getParcelable(str));
            Log.w(LOG_TAG, sbOooOoO02.toString());
