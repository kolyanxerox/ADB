...
public abstract class PostMessageServiceConnection implements PostMessageBackend, ServiceConnection {
    ...
    private OooOo mService;
    private final android.support.customtabs.OooO0OO mSessionBinder;
    ...
    public PostMessageServiceConnection(CustomTabsSessionToken customTabsSessionToken) {
        ...
        this.mSessionBinder = android.support.customtabs.OooO0O0.asInterface(callbackBinder);
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        this.mService = OooOo00.asInterface(iBinder);
