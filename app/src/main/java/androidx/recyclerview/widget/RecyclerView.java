...
import androidx.recyclerview.C0649R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public class RunnableC06801 implements Runnable {
        public RunnableC06801() {
        }
    ...
    public class RunnableC06812 implements Runnable {
        public RunnableC06812() {
        }
    ...
    public static class InterpolatorC06823 implements Interpolator {
    ...
    public class C06834 implements ViewInfoStore.ProcessCallback {
        public C06834() {
        }
    ...
    public class C06845 implements ChildHelper.Callback {
        public C06845() {
        }
        ...
        public void attachViewToParent(View view, int i, ViewGroup.LayoutParams layoutParams) {
            ...
            if (childViewHolderInt != null) {
                if (!childViewHolderInt.isTmpDetached() && !childViewHolderInt.shouldIgnore()) {
                    ...
                    throw new IllegalArgumentException(OooO00o.OooO0oo(RecyclerView.this, sb));
                }
    ...
    public class C06856 implements AdapterHelper.Callback {
        public C06856() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public class C06861 implements ViewBoundsCheck.Callback {
            public C06861() {
            }
        ...
        public class C06872 implements ViewBoundsCheck.Callback {
            public C06872() {
            }
        ...
        public LayoutManager() {
            C06861 c06861 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.1
                public C06861() {
                }
            ...
            this.mHorizontalBoundCheckCallback = c06861;
            C06872 c06872 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.2
                public C06872() {
                }
            ...
            this.mVerticalBoundCheckCallback = c06872;
            this.mHorizontalBoundCheck = new ViewBoundsCheck(c06861);
            this.mVerticalBoundCheck = new ViewBoundsCheck(c06872);
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(OooO00o.OooO0oo(this.mRecyclerView, sb));
                }
                if (iIndexOfChild != i) {
  ...
  0x000c: PHI (r3v5 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:24:0x0010, B:28:0x0016, B:21:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0649R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0649R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0649R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0649R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0649R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void ignoreView(View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(OooO00o.OooO0oo(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(View view, int i) {
            ...
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(OooO00o.OooO0oo(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder sbOooOo0o = OooOo.OooOo0o("Inconsistency detected. Invalid item position ", i, "(offset:", iFindPositionOffset, ").state:");
                sbOooOo0o.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(OooO00o.OooO0oo(RecyclerView.this, sbOooOo0o));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder sbOooOOo0 = OooOo.OooOOo0(i, "invalid position ", ". State item count is ");
            sbOooOOo0.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(OooO00o.OooO0oo(RecyclerView.this, sbOooOOo0));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (iIndexOfChild == -1) {
                ...
                sb.append(childViewHolderInt);
                throw new IllegalStateException(OooO00o.OooO0oo(RecyclerView.this, sb));
            }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isTmpDetached()) {
                ...
                throw new IllegalArgumentException(OooO00o.OooO0oo(RecyclerView.this, sb2));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(OooO00o.OooO0oo(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(OooO00o.OooO0oo(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        /* JADX WARN: Removed duplicated region for block: B:217:0x01f5 A[ADDED_TO_REGION] */
        ...
        */
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i < 0 || i >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                throw new IndexOutOfBoundsException(OooO00o.OooO0oo(RecyclerView.this, sb));
            }
    ...
    public static class State {
        ...
        public String toString() {
            ...
            return OooO00o.OooOOOO(sb, this.mRunPredictiveAnimations, '}');
        }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            float f = width;
            float f2 = i5;
            float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (iSqrt2 * 1.0f) / f)) * f2) + f2;
            if (iSqrt > 0) {
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sbOooOo = OooOo.OooOo(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            sbOooOo.append(Integer.toHexString(hashCode()));
            sbOooOo.append(" position=");
            sbOooOo.append(this.mPosition);
            sbOooOo.append(" id=");
            sbOooOo.append(this.mItemId);
            sbOooOo.append(", oldPos=");
            sbOooOo.append(this.mOldPosition);
            sbOooOo.append(", pLpos:");
            sbOooOo.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(sbOooOo.toString());
            if (isScrap()) {
                sb.append(" scrap ");
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(OooO00o.OooO0oo(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(OooO00o.OooO0oo(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        sb.append(i);
        throw new IllegalArgumentException(OooO00o.OooO0oo(this, sb));
    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(OooO00o.OooO0oo(this, OooOo.OooOo0O(str)));
        }
        throw new IllegalStateException(OooO00o.OooO0oo(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(OooO00o.OooO0oo(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(OooO00o.OooO0oo(this, new StringBuilder(""))));
        }
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(OooO00o.OooO0oo(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(OooO00o.OooO0oo(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
        Resources resources = getContext().getResources();
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0649R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0649R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0649R.dimen.fastscroll_margin));
    }
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:152:0x00dc A[PHI: r1
  0x00dc: PHI (r1v45 int) = (r1v26 int), (r1v49 int) binds: [B:146:0x00c5, B:150:0x00d8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(OooO00o.OooO0oo(layoutManager.mRecyclerView, sb));
            }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0649R.attr.recyclerViewStyle);
    }
    ...
    */
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) throws NoSuchMethodException, SecurityException {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0649R.styleable.RecyclerView, i, 0);
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 29) {
            saveAttributeDataForStyleable(context, C0649R.styleable.RecyclerView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        }
        String string = typedArrayObtainStyledAttributes.getString(C0649R.styleable.RecyclerView_layoutManager);
        if (typedArrayObtainStyledAttributes.getInt(C0649R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(C0649R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C0649R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0649R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0649R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0649R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0649R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public static class C06881 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState[] newArray(int i) {
                return new SavedState[i];
            }
