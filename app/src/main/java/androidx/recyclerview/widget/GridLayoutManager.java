...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        while (i5 < this.mSpanCount && layoutState.hasMore(state) && spanIndex > 0) {
            ...
            if (spanSize > this.mSpanCount) {
                throw new IllegalArgumentException(OooOo.OooOOO(OooOo.OooOo0o("Item at position ", i6, " requires ", spanSize, " spans but GridLayoutManager has only "), this.mSpanCount, " spans."));
            }
            spanIndex -= spanSize;
        ...
        for (int i10 = 0; i10 < i5; i10++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i7) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i12, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
                    ...
                    childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i11, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
    ...
    */
    ...
    public void setSpanCount(int i) {
        ...
        if (i < 1) {
            throw new IllegalArgumentException(OooOo.OooO0o(i, "Span count should be at least 1. Provided "));
        }
        this.mSpanCount = i;
        this.mSpanSizeLookup.invalidateSpanIndexCache();
        requestLayout();
