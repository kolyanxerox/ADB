...
class ViewBoundsCheck {
    ...
    /* renamed from: GT */
    static final int f121GT = 1;

    /* renamed from: LT */
    static final int f122LT = 4;
    ...
    public static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i2 & InterfaceC3173h3.d.b.f8827j) != 0 && (i2 & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                return false;
            }
