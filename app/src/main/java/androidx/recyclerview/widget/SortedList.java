...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        int i2 = this.mSize;
        if (i > i2) {
            StringBuilder sbOooOOo0 = OooOo.OooOOo0(i, "cannot add item to ", " because size is ");
            sbOooOOo0.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        ...
        StringBuilder sbOooOOo0 = OooOo.OooOOo0(i, "Asked to get item at ", " but size is ");
        sbOooOOo0.append(this.mSize);
        throw new IndexOutOfBoundsException(sbOooOOo0.toString());
    }
