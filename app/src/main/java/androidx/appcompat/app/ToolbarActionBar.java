...
class ToolbarActionBar extends ActionBar {
    ...
    public class C00622 implements Toolbar.OnMenuItemClickListener {
        public C00622() {
        }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Window.Callback callback) {
        C00622 c00622 = new Toolbar.OnMenuItemClickListener() { // from class: androidx.appcompat.app.ToolbarActionBar.2
            public C00622() {
            }
        ...
        toolbar.setOnMenuItemClickListener(c00622);
