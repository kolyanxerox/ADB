...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class C00631 extends ViewPropertyAnimatorListenerAdapter {
        public C00631() {
        }
    ...
    public class C00642 extends ViewPropertyAnimatorListenerAdapter {
        public C00642() {
        }
    ...
    public class C00653 implements ViewPropertyAnimatorUpdateListener {
        public C00653() {
        }
    ...
    private void init(View view) {
        ...
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0038R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0038R.id.action_context_bar);
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0038R.styleable.ActionBar, C0038R.attr.actionBarStyle, 0);
        if (typedArrayObtainStyledAttributes.getBoolean(C0038R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0038R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0038R.attr.actionBarWidgetTheme, typedValue, true);
