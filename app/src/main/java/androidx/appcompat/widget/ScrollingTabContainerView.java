...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class RunnableC01041 implements Runnable {
        ...
        public RunnableC01041(View view) {
            view = view;
        }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            ...
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, iArr, C0038R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (zIsEmpty) {
                ...
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0038R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0038R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0038R.attr.actionBarTabBarStyle);
    ...
    public void animateToTab(int i) {
        ...
        RunnableC01041 runnableC01041 = new Runnable() { // from class: androidx.appcompat.widget.ScrollingTabContainerView.1
            final /* synthetic */ View val$tabView;

            public RunnableC01041(View childAt2) {
                view = childAt2;
            }
        ...
        this.mTabSelector = runnableC01041;
        post(runnableC01041);
    }
