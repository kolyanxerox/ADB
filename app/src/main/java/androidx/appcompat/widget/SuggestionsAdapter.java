...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0038R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0038R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getActivityIcon(ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            StringBuilder sbOooOOo0 = OooOo.OooOOo0(iconResource, "Invalid icon resource ", " for ");
            sbOooOOo0.append(componentName.flattenToShortString());
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0038R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
