    ...
    private void onMeasureExactFormat(int i, int i2) {
            ...
            while (i25 < childCount) {
                ...
                if ((j3 & j4) == 0) {
                    ...
                    if (!z8 || !layoutParams3.preventEdgeOffset) {
                        ...
                        z = true;
                        i6 = i25;
                        childAt2.setPadding(i27 + i3, 0, i27, 0);
                    } else {
                        i6 = i25;
                        z = true;
                    }
        ...
        if (i10 <= 0 || j2 == 0 || (i10 >= i14 - 1 && !z9 && iMax2 <= 1)) {
            ...
            if (z9) {
                ...
                if ((j2 & (1 << i28)) != 0 && !((LayoutParams) getChildAt(i28).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i29 = fBitCount > 0.0f ? (int) ((i10 * i3) / fBitCount) : i5;
        ...
        if (z6) {
            for (int i31 = i5; i31 < childCount; i31++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i3) + layoutParams5.extraPixels, BasicMeasure.EXACTLY), childMeasureSpec);
                }
            }
        }
        setMeasuredDimension(i8, mode != 1073741824 ? i4 : i18);
    }
