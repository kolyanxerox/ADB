...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0038R.id.action_bar);
        this.mContextView = findViewById(C0038R.id.action_context_bar);
    }
  ...
  0x0049: PHI (r1v8 boolean) = (r1v1 boolean), (r1v1 boolean), (r1v0 boolean) binds: [B:31:0x00a6, B:33:0x00aa, B:15:0x003a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0038R.styleable.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(C0038R.styleable.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(C0038R.styleable.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0038R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0038R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(C0038R.styleable.ActionBar_backgroundSplit);
        }
