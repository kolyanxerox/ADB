...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0038R.styleable.ActionBar, C0038R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0038R.styleable.ActionBar_height, 0));
    ...
    public AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0038R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
