...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0038R.layout.abc_cascading_menu_item_layout;
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.1
        public ViewTreeObserverOnGlobalLayoutListenerC00701() {
        }
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.2
        public ViewOnAttachStateChangeListenerC00712() {
        }
    ...
    public class ViewTreeObserverOnGlobalLayoutListenerC00701 implements ViewTreeObserver.OnGlobalLayoutListener {
        public ViewTreeObserverOnGlobalLayoutListenerC00701() {
        }
    ...
    public class ViewOnAttachStateChangeListenerC00712 implements View.OnAttachStateChangeListener {
        public ViewOnAttachStateChangeListenerC00712() {
        }
    ...
    public class C00723 implements MenuItemHoverListener {
    ...
    public CascadingMenuPopup(Context context, View view, int i, int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0038R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menuBuilder) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(C0038R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
