...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            ...
            sb.append(" position=");
            return OooOo.OooOOO(sb, this.position, "}");
        }
    ...
    public void onMeasure(int i, int i2) throws Resources.NotFoundException {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8 && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                int i7 = i6 & 7;
                int i8 = i6 & InterfaceC3173h3.d.b.f8827j;
  ...
  0x00cc: PHI (r14v6 float) = (r14v4 float), (r14v5 float), (r14v3 float) binds: [B:64:0x00f0, B:61:0x00da, B:53:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void smoothScrollTo(int i, int i2, int i3) throws Resources.NotFoundException {
        ...
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i5) / ((this.mAdapter.getPageWidth(this.mCurItem) * f) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
