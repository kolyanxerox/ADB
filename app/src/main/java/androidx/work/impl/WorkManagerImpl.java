...
public class WorkManagerImpl extends WorkManager {
    ...
    public class RunnableC08831 implements Runnable {
        final /* synthetic */ SettableFuture val$future;
        final /* synthetic */ PreferenceUtils val$preferenceUtils;

        public RunnableC08831(SettableFuture settableFuture, PreferenceUtils preferenceUtils) {
        ...
        public void run() {
            try {
                settableFuture.set(Long.valueOf(preferenceUtils.getLastCancelAllTimeMillis()));
            } catch (Throwable th) {
    ...
    public class C08842 implements Function<List<WorkSpec.WorkInfoPojo>, WorkInfo> {
        public C08842() {
        }
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C0870R.bool.workmanager_test_configuration));
    }
    ...
    @Override // androidx.work.WorkManager
    public OooOOO getLastCancelAllTimeMillis() {
        SettableFuture settableFutureCreate = SettableFuture.create();
        this.mWorkTaskExecutor.executeOnBackgroundThread(new Runnable() { // from class: androidx.work.impl.WorkManagerImpl.1
            final /* synthetic */ SettableFuture val$future;
            final /* synthetic */ PreferenceUtils val$preferenceUtils;

            public RunnableC08831(SettableFuture settableFutureCreate2, PreferenceUtils preferenceUtils) {
                settableFuture = settableFutureCreate2;
                preferenceUtils = preferenceUtils;
            }
    ...
    @Override // androidx.work.WorkManager
    public OooOOO getWorkInfoById(UUID uuid) {
    ...
    @Override // androidx.work.WorkManager
    public OooOOO getWorkInfos(WorkQuery workQuery) {
    ...
    @Override // androidx.work.WorkManager
    public OooOOO getWorkInfosByTag(String str) {
    ...
    @Override // androidx.work.WorkManager
    public OooOOO getWorkInfosForUniqueWork(String str) {
