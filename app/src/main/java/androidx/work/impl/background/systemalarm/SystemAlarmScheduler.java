...
public class SystemAlarmScheduler implements Scheduler {
    ...
    private void scheduleWorkSpec(WorkSpec workSpec) {
        Logger.get().debug(TAG, OooOo.OooOO0("Scheduling work with workSpecId ", workSpec.f129id), new Throwable[0]);
        this.mContext.startService(CommandHandler.createScheduleWorkIntent(this.mContext, workSpec.f129id));
    }
