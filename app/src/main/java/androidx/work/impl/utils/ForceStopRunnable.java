...
public class ForceStopRunnable implements Runnable {
        ...
        try {
            ...
            if (z) {
                for (WorkSpec workSpec : runningWork) {
                    workSpecDao.setState(WorkInfo.State.ENQUEUED, workSpec.f129id);
                    workSpecDao.markWorkSpecScheduled(workSpec.f129id, -1L);
                }
            }
    ...
    public void forceStopRunnable() throws SQLException {
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    for (int i = 0; i < historicalProcessExitReasons.size(); i++) {
                        if (Oooo0.OooO0Oo(historicalProcessExitReasons.get(i)).getReason() == 10) {
                            return true;
                        }
                    }
                }
