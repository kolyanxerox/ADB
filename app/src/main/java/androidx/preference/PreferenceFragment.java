...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    private int mLayoutResId = C0615R.layout.preference_list_fragment;
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().getTheme().resolveAttribute(C0615R.attr.preferenceTheme, typedValue, true);
        int i = typedValue.resourceId;
        if (i == 0) {
            i = C0615R.style.PreferenceThemeOverlay;
        }
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.mStyledContext.getPackageManager().hasSystemFeature("android.hardware.type.automotive") && (recyclerView = (RecyclerView) viewGroup.findViewById(C0615R.id.recycler_view)) != null) {
            return recyclerView;
        }
        RecyclerView recyclerView2 = (RecyclerView) layoutInflater.inflate(C0615R.layout.preference_recyclerview, viewGroup, false);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0615R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(context, C0615R.attr.preferenceFragmentStyle, android.R.attr.preferenceFragmentStyle), 0);
        this.mLayoutResId = typedArrayObtainStyledAttributes.getResourceId(C0615R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C0615R.styleable.PreferenceFragment_android_divider);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0615R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C0615R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
    ...
    public void setPreferencesFromResource(int i, String str) {
        ...
        if (str != null) {
            ...
            if (!z) {
                throw new IllegalArgumentException(OooOo.OooOO0O("Preference object with key ", str, " is not a PreferenceScreen"));
            }
        }
