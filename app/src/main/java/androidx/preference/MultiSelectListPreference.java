...
public class MultiSelectListPreference extends DialogPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0615R.styleable.MultiSelectListPreference, i, i2);
        this.mEntries = TypedArrayUtils.getTextArray(typedArrayObtainStyledAttributes, C0615R.styleable.MultiSelectListPreference_entries, C0615R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(typedArrayObtainStyledAttributes, C0615R.styleable.MultiSelectListPreference_entryValues, C0615R.styleable.MultiSelectListPreference_android_entryValues);
