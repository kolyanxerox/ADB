...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public static class PreferenceResourceDescriptor {
        ...
        public int hashCode() {
            return this.mClassName.hashCode() + ((((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.mLayoutResId) * 31) + this.mWidgetLayoutResId) * 31);
        }
    }
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes((AttributeSet) null, C0615R.styleable.BackgroundStyle);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C0615R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
