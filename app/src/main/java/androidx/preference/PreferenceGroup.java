...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0615R.styleable.PreferenceGroup, i, i2);
        int i3 = C0615R.styleable.PreferenceGroup_orderingFromXml;
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i3, i3, true);
        if (typedArrayObtainStyledAttributes.hasValue(C0615R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            int i4 = C0615R.styleable.PreferenceGroup_initialExpandedChildrenCount;
    ...
    public static class SavedState extends Preference.BaseSavedState {
        ...
        public class C06091 implements Parcelable.Creator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel);
            }
