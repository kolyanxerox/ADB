...
public class Preference implements Comparable<Preference> {
    ...
    public static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add(0, 0, 0, C0615R.string.copy).setOnMenuItemClickListener(this);
        }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C0615R.string.preference_copied, summary), 0).show();
            return true;
        }
    }
    ...
    public Preference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLayoutResId = C0615R.layout.preference;
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0615R.styleable.Preference, i, i2);
        this.mIconResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_icon, C0615R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_key, C0615R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_title, C0615R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_summary, C0615R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_order, C0615R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_fragment, C0615R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_layout, C0615R.styleable.Preference_android_layout, C0615R.layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_widgetLayout, C0615R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_enabled, C0615R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_selectable, C0615R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_persistent, C0615R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_dependency, C0615R.styleable.Preference_android_dependency);
        int i3 = C0615R.styleable.Preference_allowDividerAbove;
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i3, i3, this.mSelectable);
        int i4 = C0615R.styleable.Preference_allowDividerBelow;
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i4, i4, this.mSelectable);
        if (typedArrayObtainStyledAttributes.hasValue(C0615R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_defaultValue);
        } else if (typedArrayObtainStyledAttributes.hasValue(C0615R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_shouldDisableView, C0615R.styleable.Preference_android_shouldDisableView, true);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C0615R.styleable.Preference_singleLineTitle);
        this.mHasSingleLineTitleAttr = zHasValue;
        if (zHasValue) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_singleLineTitle, C0615R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0615R.styleable.Preference_iconSpaceReserved, C0615R.styleable.Preference_android_iconSpaceReserved, false);
        int i5 = C0615R.styleable.Preference_isPreferenceVisible;
        this.mVisible = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i5, i5, true);
        int i6 = C0615R.styleable.Preference_enableCopying;
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        View viewFindViewById = preferenceViewHolder.findViewById(C0615R.id.icon_frame);
    ...
    public Preference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0615R.attr.preferenceStyle, android.R.attr.preferenceStyle));
    }
