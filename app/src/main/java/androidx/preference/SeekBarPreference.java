...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0615R.styleable.SeekBarPreference, i, i2);
        this.mMin = typedArrayObtainStyledAttributes.getInt(C0615R.styleable.SeekBarPreference_min, 0);
        setMax(typedArrayObtainStyledAttributes.getInt(C0615R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(typedArrayObtainStyledAttributes.getInt(C0615R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = typedArrayObtainStyledAttributes.getBoolean(C0615R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = typedArrayObtainStyledAttributes.getBoolean(C0615R.styleable.SeekBarPreference_showSeekBarValue, false);
        this.mUpdatesContinuously = typedArrayObtainStyledAttributes.getBoolean(C0615R.styleable.SeekBarPreference_updatesContinuously, false);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSeekBar = (SeekBar) preferenceViewHolder.findViewById(C0615R.id.seekbar);
        TextView textView = (TextView) preferenceViewHolder.findViewById(C0615R.id.seekbar_value);
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0615R.attr.seekBarPreferenceStyle);
    }
