...
public class EditTextPreference extends DialogPreference {
    ...
    public static final class SimpleSummaryProvider implements Preference.SummaryProvider<EditTextPreference> {
        ...
        public CharSequence provideSummary(EditTextPreference editTextPreference) {
            return TextUtils.isEmpty(editTextPreference.getText()) ? editTextPreference.getContext().getString(C0615R.string.not_set) : editTextPreference.getText();
        }
    }

    public EditTextPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0615R.styleable.EditTextPreference, i, i2);
        int i3 = C0615R.styleable.EditTextPreference_useSimpleSummaryProvider;
    ...
    public EditTextPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0615R.attr.editTextPreferenceStyle, android.R.attr.editTextPreferenceStyle));
    }
