...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    public final V getOrPut(float f, OooO0O0 defaultValue) {
    ...
    */
    ...
    public /* synthetic */ MutableFloatObjectMap(int i, int i2, OooOO0O oooOO0O) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    */
    public final boolean remove(float r17, V r18) {
        ...
        L69:
            ...
            r1 = r1[r10]
            r6 = r18
            boolean r1 = kotlin.jvm.internal.OooOo.OooO00o(r1, r6)
            if (r1 == 0) goto L7b
