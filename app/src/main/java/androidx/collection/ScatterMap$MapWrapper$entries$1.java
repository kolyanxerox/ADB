...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, OooO0OO {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!OooOo.OooO00o(scatterMap.get(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return o00O0O0O.OooOo00(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
    }
