...
public final class ScatterMap$MapWrapper$keys$1<K> implements Set<K>, OooO0OO {
    ...
    public Iterator<K> iterator() {
        return o00O0O0O.OooOo00(new ScatterMap$MapWrapper$keys$1$iterator$1(this.this$0, null));
    }
