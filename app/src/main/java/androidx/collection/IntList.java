...
public abstract class IntList {
    ...
    public /* synthetic */ IntList(int i, OooOO0O oooOO0O) {
        this(i);
    }
    ...
    public final int elementAtOrElse(int i, Oooo000 defaultValue) {
    ...
    public final int first(Oooo000 predicate) {
        OooOo.OooO0o0(predicate, "predicate");
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public static /* synthetic */ String joinToString$default(IntList intList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence, Oooo000 oooo000, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 1) != 0) {
                separator = ", ";
            }
            ...
            while (true) {
                if (i4 < i3) {
                    ...
                    sbOooOo00.append((CharSequence) oooo000.invoke(Integer.valueOf(i5)));
                    i4++;
                } else {
    ...
    public final int last(Oooo000 predicate) {
        int i;
        OooOo.OooO0o0(predicate, "predicate");
        int[] iArr = this.content;
        int i2 = this._size;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence charSequence, Oooo000 oooo000) {
        ...
        while (true) {
            if (i3 < i2) {
                ...
                sbOooOo00.append((CharSequence) oooo000.invoke(Integer.valueOf(i4)));
                i3++;
            } else {
                sbOooOo00.append(postfix);
                break;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence charSequence, Oooo000 oooo000) {
        ...
        while (true) {
            if (i2 < i) {
                ...
                sbOooOo00.append((CharSequence) oooo000.invoke(Integer.valueOf(i3)));
                i2++;
            } else {
                sbOooOo00.append(charSequence);
                break;
