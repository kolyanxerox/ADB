...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    private static int measureChildHeight(View view, int i, int i2) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        return (((ViewGroup.MarginLayoutParams) layoutParams).width != 0 || layoutParams.weight <= 0.0f) ? View.MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), BasicMeasure.EXACTLY) : ViewGroup.getChildMeasureSpec(i, i2, ((ViewGroup.MarginLayoutParams) layoutParams).height);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int iMax3 = Math.max(i7 - (((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin), 0);
                int i8 = ((ViewGroup.MarginLayoutParams) layoutParams).width;
                i4 = i5;
                childAt.measure(i8 == -2 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode == 0 ? mode : Integer.MIN_VALUE) : i8 == -1 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode) : View.MeasureSpec.makeMeasureSpec(i8, BasicMeasure.EXACTLY), ViewGroup.getChildMeasureSpec(i2, getPaddingBottom() + getPaddingTop(), ((ViewGroup.MarginLayoutParams) layoutParams).height));
        ...
        if (z || f > 0.0f) {
            ...
            while (i10 < childCount) {
                ...
                if (childAt2.getVisibility() != i3) {
                    ...
                    if (z) {
                        iMax = i9 - (((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin);
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, BasicMeasure.EXACTLY);
                    } else if (layoutParams2.weight > 0.0f) {
                        iMax = measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i6)) / f));
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, BasicMeasure.EXACTLY);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
                    }
                    int iMeasureChildHeight = measureChildHeight(childAt2, i2, getPaddingBottom() + getPaddingTop());
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(i9 - i12, BasicMeasure.EXACTLY), iMakeMeasureSpec2);
                        if (i11 != 0) {
