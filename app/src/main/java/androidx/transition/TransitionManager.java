...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo13536clone = transition.mo13536clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo13536clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo13536clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo13536clone);
    }
    ...
    /* renamed from: go */
    public static void m39go(Scene scene) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo13536clone = transition.mo13536clone();
        sceneChangeSetup(viewGroup, transitionMo13536clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo13536clone);
    }

    /* renamed from: go */
    public static void m40go(Scene scene, Transition transition) {
