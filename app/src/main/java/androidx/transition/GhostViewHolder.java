...
class GhostViewHolder extends FrameLayout {
    ...
    public GhostViewHolder(ViewGroup viewGroup) {
        ...
        viewGroup.setTag(C0756R.id.ghost_view_holder, this);
        ViewGroupUtils.getOverlay(this.mParent).add(this);
        this.mAttached = true;
    }

    public static GhostViewHolder getHolder(ViewGroup viewGroup) {
        return (GhostViewHolder) viewGroup.getTag(C0756R.id.ghost_view_holder);
    }
    ...
    public void onViewRemoved(View view) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == view) || getChildCount() == 0) {
            this.mParent.setTag(C0756R.id.ghost_view_holder, null);
