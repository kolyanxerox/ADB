...
public class TransitionSet extends Transition {
    ...
    public void runAnimators() {
        ...
        for (int i2 = 1; i2 < this.mTransitions.size(); i2++) {
            Transition transition2 = this.mTransitions.get(i2 - 1);
            final Transition transition3 = this.mTransitions.get(i2);
    ...
    public TransitionSet setOrdering(int i) {
        ...
        if (i != 1) {
            throw new AndroidRuntimeException(OooOo.OooO0o(i, "Invalid parameter for TransitionSet ordering: "));
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder sbOooOo = OooOo.OooOo(string, "\n");
            sbOooOo.append(this.mTransitions.get(i).toString(str + "  "));
    ...
    public Transition mo13536clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo13536clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo13536clone());
        }
