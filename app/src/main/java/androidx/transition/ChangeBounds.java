...
public class ChangeBounds extends Transition {
    ...
    static {
        ...
        POSITION_PROPERTY = new Property<View, PointF>(cls, C3034d9.h.f8078L) { // from class: androidx.transition.ChangeBounds.6
            @Override // android.util.Property
            public PointF get(View view) {
                return null;
            }
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i > 0) {
                if (this.mResizeClip) {
                    ...
                    ObjectAnimator objectAnimatorOfPointF = (i3 == i4 && i5 == i6) ? null : ObjectAnimatorUtils.ofPointF(view2, POSITION_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
                    if (rect4 == null) {
                        i2 = 0;
                    ...
                    if (rect.equals(rect6)) {
                        ...
                        objectAnimatorOfObject.addListener(new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeBounds.8
                            ...
                            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                            public void onAnimationEnd(Animator animator2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                                if (this.mIsCanceled) {
                                    return;
                                }
                    ...
                    if (i != 2) {
                        animatorMergeAnimators = (i3 == i4 && i5 == i6) ? ObjectAnimatorUtils.ofPointF(view2, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i7, i9, i8, i10)) : ObjectAnimatorUtils.ofPointF(view2, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
