...
class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0756R.id.save_non_transition_alpha, null);
        }
    }

    public float getTransitionAlpha(View view) {
        Float f = (Float) view.getTag(C0756R.id.save_non_transition_alpha);
        return f != null ? view.getAlpha() / f.floatValue() : view.getAlpha();
    }

    public void saveNonTransitionAlpha(View view) {
        if (view.getTag(C0756R.id.save_non_transition_alpha) == null) {
            view.setTag(C0756R.id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }
    ...
    public void setTransitionAlpha(View view, float f) {
        Float f2 = (Float) view.getTag(C0756R.id.save_non_transition_alpha);
        if (f2 != null) {
