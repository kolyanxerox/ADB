...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder sbOooOo = OooOo.OooOo(strOooOoo0, "current group is :");
        sbOooOo.append(vGroup.getGroupName());
        sbOooOo.append(" rotation is ");
        sbOooOo.append(vGroup.mRotate);
        Log.v(LOGTAG, sbOooOo.toString());
        Log.v(LOGTAG, strOooOoo0 + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                sbOooOo0O.append(pathDataNodeArr[i].mType);
                sbOooOo0O.append(TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER);
                string = sbOooOo0O.toString();
                for (float f : pathDataNodeArr[i].mParams) {
                    StringBuilder sbOooOo0O2 = OooOo.OooOo0O(string);
                    sbOooOo0O2.append(f);
                    sbOooOo0O2.append(",");
                    string = sbOooOo0O2.toString();
                }
            }
            return string;
        }
        ...
        public void printVPath(int i) {
            ...
            StringBuilder sbOooOo = OooOo.OooOo(strOooOoo0, "current path is :");
            sbOooOo.append(this.mPathName);
            sbOooOo.append(" pathData is ");
            sbOooOo.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbOooOo.toString());
        }
