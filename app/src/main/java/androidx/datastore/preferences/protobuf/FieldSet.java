...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public /* synthetic */ Builder(C03961 c03961) {
            this();
        }
    ...
    public /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C03961 c03961) {
        this(smallSortedMap);
    }
    ...
    public static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (C03961.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C03961.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 7:
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C03961) null);
    }
