...
public abstract class CodedInputStream {
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        public /* synthetic */ ArrayDecoder(byte[] bArr, int i, int i2, boolean z, C03621 c03621) {
            this(bArr, i, i2, z);
        }
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public /* synthetic */ IterableDirectByteBufferDecoder(Iterable iterable, int i, boolean z, C03621 c03621) {
            this(iterable, i, z);
        }
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return ((UnsafeUtil.getByte(j + 3) & ForkServer.ERROR) << 24) | (UnsafeUtil.getByte(j) & ForkServer.ERROR) | ((UnsafeUtil.getByte(1 + j) & ForkServer.ERROR) << 8) | ((UnsafeUtil.getByte(2 + j) & ForkServer.ERROR) << 16);
        }
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        public /* synthetic */ StreamDecoder(InputStream inputStream, int i, C03621 c03621) {
            this(inputStream, i);
        }
        ...
        private boolean tryRefillBuffer(int i) throws IOException {
            ...
            if (i2 + i <= this.bufferSize) {
                throw new IllegalStateException(OooOo.OooO0oO(i, "refillBuffer() called when ", " bytes were already available in buffer"));
            }
    ...
    public static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        public /* synthetic */ UnsafeDirectNioDecoder(ByteBuffer byteBuffer, boolean z, C03621 c03621) {
            this(byteBuffer, z);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:73:0x008c, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r3) < 0) goto L74;
         */
        @Override // androidx.datastore.preferences.protobuf.CodedInputStream
        /*
    ...
    public /* synthetic */ CodedInputStream(C03621 c03621) {
        this();
    }
    ...
    public final int setRecursionLimit(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(OooOo.OooO0o(i, "Recursion limit cannot be negative: "));
        }
    ...
    public final int setSizeLimit(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(OooOo.OooO0o(i, "Size limit cannot be negative: "));
        }
