...
public final class WireFormat {
    ...
    public static class FieldType extends java.lang.Enum<FieldType> {
        ...
        public enum C04331 extends FieldType {
            public C04331(String str, int i, JavaType javaType, int i2) {
        ...
        public enum C04342 extends FieldType {
            public C04342(String str, int i, JavaType javaType, int i2) {
                super(str, i, javaType, i2, null);
            }
        ...
        public enum C04353 extends FieldType {
            public C04353(String str, int i, JavaType javaType, int i2) {
                super(str, i, javaType, i2, null);
            }
        ...
        public enum C04364 extends FieldType {
            public C04364(String str, int i, JavaType javaType, int i2) {
                super(str, i, javaType, i2, null);
            }
        ...
        static {
            ...
            BOOL = fieldType8;
            C04331 c04331 = new FieldType("STRING", 8, JavaType.STRING, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat.FieldType.1
                public C04331(String str, int i, JavaType javaType3, int i2) {
                    super(str, i, javaType3, i2, null);
                }
            ...
            C04342 c04342 = new FieldType("GROUP", 9, javaType3, 3) { // from class: androidx.datastore.preferences.protobuf.WireFormat.FieldType.2
                public C04342(String str, int i, JavaType javaType32, int i2) {
                    super(str, i, javaType32, i2, null);
                }
            ...
            GROUP = c04342;
            C04353 c04353 = new FieldType("MESSAGE", 10, javaType32, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat.FieldType.3
                public C04353(String str, int i, JavaType javaType32, int i2) {
                    super(str, i, javaType32, i2, null);
                }
            ...
            MESSAGE = c04353;
            C04364 c04364 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, 2) { // from class: androidx.datastore.preferences.protobuf.WireFormat.FieldType.4
                public C04364(String str, int i, JavaType javaType4, int i2) {
                    super(str, i, javaType4, i2, null);
                }
            ...
            SINT64 = fieldType14;
            $VALUES = new FieldType[]{fieldType, fieldType2, fieldType3, fieldType4, fieldType5, fieldType6, fieldType7, fieldType8, c04331, c04342, c04353, c04364, fieldType9, fieldType10, fieldType11, fieldType12, fieldType13, fieldType14};
        }

        public /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C04321 c04321) {
    ...
    public enum Utf8Validation {
        ...
        /* renamed from: androidx.datastore.preferences.protobuf.WireFormat$Utf8Validation$1 */
        public enum C04371 extends Utf8Validation {
            @Override // androidx.datastore.preferences.protobuf.WireFormat.Utf8Validation
            public Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readString();
            }
        ...
        /* renamed from: androidx.datastore.preferences.protobuf.WireFormat$Utf8Validation$2 */
        public enum C04382 extends Utf8Validation {
            @Override // androidx.datastore.preferences.protobuf.WireFormat.Utf8Validation
            public Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readStringRequireUtf8();
            }
        ...
        /* renamed from: androidx.datastore.preferences.protobuf.WireFormat$Utf8Validation$3 */
        public enum C04393 extends Utf8Validation {
            @Override // androidx.datastore.preferences.protobuf.WireFormat.Utf8Validation
            public Object readString(CodedInputStream codedInputStream) throws IOException {
                return codedInputStream.readBytes();
            }
        ...
        /* synthetic */ Utf8Validation(C04321 c04321) {
            this();
        }
    }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C04321.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
