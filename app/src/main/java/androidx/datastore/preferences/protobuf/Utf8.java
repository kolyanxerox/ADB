...
final class Utf8 {
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            if (str.indexOf(com.applovin.shadow.okio.Utf8.REPLACEMENT_CODE_POINT) >= 0 && !Arrays.equals(str.getBytes(charset), Arrays.copyOfRange(bArr, i, i2 + i))) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
            return str;
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:122:0x009e, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L123;
         */
        /* JADX WARN: Code restructure failed: missing block: B:99:0x0058, code lost:
        
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L102;
         */
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:118:0x00a3, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L119;
         */
        /* JADX WARN: Code restructure failed: missing block: B:76:0x002d, code lost:
        
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L79;
         */
        /* JADX WARN: Code restructure failed: missing block: B:97:0x0061, code lost:
        
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L98;
         */
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
