...
class IterableByteBufferInputStream extends InputStream {
    ...
    public int read() throws IOException {
        ...
        if (this.hasArray) {
            int i = this.currentArray[this.currentByteBufferPos + this.currentArrayOffset] & ForkServer.ERROR;
            updateCurrentByteBufferPos(1);
            return i;
        }
        int i2 = UnsafeUtil.getByte(this.currentByteBufferPos + this.currentAddress) & ForkServer.ERROR;
        updateCurrentByteBufferPos(1);
        return i2;
    }
