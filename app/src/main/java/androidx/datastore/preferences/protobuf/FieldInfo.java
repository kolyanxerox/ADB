...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(C03941 c03941) {
            this();
        }
    ...
    private static void checkFieldNumber(int i) {
        if (i <= 0) {
            throw new IllegalArgumentException(OooOo.OooO0o(i, "fieldNumber must be positive: "));
        }
    }
    ...
    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i2, boolean z, Internal.EnumVerifier enumVerifier) {
        ...
        throw new IllegalArgumentException(OooOo.OooO0o(i2, "presenceMask must have exactly one bit set: "));
    }
    ...
    public Class<?> getMessageFieldClass() {
        int i = C03941.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
