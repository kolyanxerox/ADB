...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        public OutOfSpaceException(String str) {
            super(OooOo.OooOO0("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }
        ...
        public OutOfSpaceException(String str, Throwable th) {
            super(OooOo.OooOO0("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    }
    ...
    public /* synthetic */ CodedOutputStream(C03641 c03641) {
        this();
    }
