...
public class ProfileInstaller {
    ...
    public class C06461 implements DiagnosticsCallback {
        @Override // androidx.profileinstaller.ProfileInstaller.DiagnosticsCallback
        public void onDiagnosticReceived(int i, Object obj) {
        }
    ...
    public class C06472 implements DiagnosticsCallback {
        static final String TAG = "ProfileInstaller";
    ...
    public static void diagnostic(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new OooO0O0(diagnosticsCallback, i, obj, 1));
    }
    ...
    public static void noteProfileWrittenFor(PackageInfo packageInfo, File file) throws IOException {
        try {
    ...
    public static void result(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new OooO0O0(diagnosticsCallback, i, obj, 0));
    }
    ...
    public static void writeProfile(Context context) throws PackageManager.NameNotFoundException {
        writeProfile(context, new androidx.arch.core.executor.OooO00o(2), EMPTY_DIAGNOSTICS);
    }

    public static void writeSkipFile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback) throws PackageManager.NameNotFoundException, IOException {
        try {
    ...
    public static void writeProfile(Context context, Executor executor, DiagnosticsCallback diagnosticsCallback, boolean z) throws PackageManager.NameNotFoundException {
