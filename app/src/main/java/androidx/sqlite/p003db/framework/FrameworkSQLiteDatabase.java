...
class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public class C07241 implements SQLiteDatabase.CursorFactory {
        final /* synthetic */ SupportSQLiteQuery val$supportQuery;

        public C07241(SupportSQLiteQuery supportSQLiteQuery) {
    ...
    public class C07252 implements SQLiteDatabase.CursorFactory {
        final /* synthetic */ SupportSQLiteQuery val$supportQuery;

        public C07252(SupportSQLiteQuery supportSQLiteQuery) {
            supportSQLiteQuery = supportSQLiteQuery;
        }
    ...
    public int delete(String str, String str2, Object[] objArr) {
        ...
        sb.append(str);
        sb.append(TextUtils.isEmpty(str2) ? "" : OooOo.OooOO0(" WHERE ", str2));
    ...
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery) {
        return this.mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: androidx.sqlite.db.framework.FrameworkSQLiteDatabase.1
            ...
            public C07241(SupportSQLiteQuery supportSQLiteQuery2) {
        ...
        }, supportSQLiteQuery2.getSql(), EMPTY_STRING_ARRAY, null);
    }
    ...
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        return this.mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: androidx.sqlite.db.framework.FrameworkSQLiteDatabase.2
            ...
            public C07252(SupportSQLiteQuery supportSQLiteQuery2) {
                supportSQLiteQuery = supportSQLiteQuery2;
            }
        ...
        }, supportSQLiteQuery2.getSql(), EMPTY_STRING_ARRAY, null, cancellationSignal);
    }
}
