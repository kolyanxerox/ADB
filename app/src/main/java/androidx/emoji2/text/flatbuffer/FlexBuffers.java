...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f108bb.data());
        ...
        public byte get(int i) {
            return this.f108bb.get(this.end + i);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f108bb.get(this.end + i);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f108bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f108bb.getString(this.end, size()));
            sb.append('\"');
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f108bb.get(i) != 0) {
                i++;
            }
            int i2 = this.end;
            return this.f108bb.getString(i2, i - i2);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            ReadBuf readBuf = typedVector2.f108bb;
    ...
    public static class Map extends Vector {
        ...
        public Vector values() {
            return new Vector(this.f108bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public Blob asBlob() {
            ...
            ReadBuf readBuf = this.f109bb;
            return new Blob(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
        }

        public boolean asBoolean() {
            return isBoolean() ? this.f109bb.get(this.end) != 0 : asUInt() != 0;
        }

        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return FlexBuffers.readInt(this.f109bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
            ...
            return FlexBuffers.readUInt(this.f109bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            if (i == 2) {
                return (int) FlexBuffers.readUInt(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (int) FlexBuffers.readDouble(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 5) {
        ...
        public long asLong() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readLong(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                return FlexBuffers.readUInt(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f109bb, this.end, this.parentWidth);
            }
            if (i == 5) {
                try {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f109bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f109bb;
                int i = this.byteWidth;
                return this.f109bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i, i));
            }
            if (!isKey()) {
                return "";
            }
            int iIndirect2 = FlexBuffers.indirect(this.f109bb, this.end, this.byteWidth);
            int i2 = iIndirect2;
            while (this.f109bb.get(i2) != 0) {
                i2++;
            }
            return this.f109bb.getString(iIndirect2, i2 - iIndirect2);
        }
    ...
    public static abstract class Sized extends Object {
        ...
        public Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f108bb, i - i2, i2);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f108bb, (i * this.byteWidth) + this.end, this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f108bb, (i * this.byteWidth) + this.end, this.byteWidth, Unsigned.byteToUnsignedInt(this.f108bb.get((int) ((size * this.byteWidth) + this.end + j))));
        }
