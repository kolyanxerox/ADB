...
public class FlatBufferBuilder {
    ...
    public void clear() {
        this.space = this.f107bb.capacity();
        this.f107bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i;
        byteBuffer.position(i);
        this.utf8.encodeUtf8(charSequence, this.f107bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f107bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f107bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f107bb.getShort(iCapacity);
            if (s == this.f107bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f107bb.getShort(iCapacity + i7) != this.f107bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int iCapacity2 = this.f107bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f107bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f107bb.capacity() - this.space);
        }
        this.f107bb.position(this.space);
        this.finished = true;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        byteBuffer.clear();
        this.f107bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f107bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
    ...
    public int offset() {
        return this.f107bb.capacity() - this.space;
    }
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f107bb.capacity() - i;
        if (this.f107bb.getShort((iCapacity - this.f107bb.getInt(iCapacity)) + i2) == 0) {
            throw new AssertionError(OooOo.OooO0oO(i2, "FlatBuffers: field ", " must be set"));
        }
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f107bb.position(i);
        this.f107bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f107bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f107bb.capacity());
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f107bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f107bb.capacity();
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f107bb.capacity() - this.space);
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f107bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f107bb.put(byteBuffer);
        return endVector();
    }
