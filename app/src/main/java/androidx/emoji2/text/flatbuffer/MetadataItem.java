...
public final class MetadataItem extends Table {
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(Table.__indirect(__element(i), this.f106bb), this.f106bb);
        }
    }
    ...
    public int codepoints(int i) {
        ...
        return this.f112bb.getInt((i * 4) + __vector(i__offset));
    }
    ...
    public short compatAdded() {
        ...
        if (i__offset != 0) {
            return this.f112bb.getShort(i__offset + this.bb_pos);
        }
        return (short) 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (i__offset == 0 || this.f112bb.get(i__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public int m35id() {
        ...
        if (i__offset != 0) {
            return this.f112bb.getInt(i__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int i__offset = __offset(16);
        if (i__offset != 0) {
            return intVector.__assign(__vector(i__offset), this.f112bb);
        }
        return null;
    }
}
