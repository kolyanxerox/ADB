...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f37id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i3 = iArr2[i2];
        if (i3 == -1) {
            iArr2[i2] = i;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.variables[i] = solverVariable.f37id;
        this.values[i] = f;
        this.previous[i] = -1;
        this.next[i] = -1;
    ...
    private void displayHash() {
        for (int i = 0; i < this.HASH_SIZE; i++) {
            if (this.keys[i] != -1) {
                ...
                boolean z = false;
                while (!z) {
                    StringBuilder sbOooOo = OooOo.OooOo(string, StringUtils.SPACE);
                    sbOooOo.append(this.variables[i2]);
    ...
    public String toString() {
        String strOooOoo0;
        String strOooOoo02;
        String strOooOoo03 = hashCode() + " { ";
        int i = this.mCount;
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str = strOooOoo03 + variable + " = " + getVariableValue(i2) + StringUtils.SPACE;
                int iIndexOf = indexOf(variable);
                String strOooOoo04 = OooOo.OooOoo0(str, "[p: ");
                if (this.previous[iIndexOf] != -1) {
                    StringBuilder sbOooOo0O = OooOo.OooOo0O(strOooOoo04);
                    sbOooOo0O.append(this.mCache.mIndexedVariables[this.variables[this.previous[iIndexOf]]]);
                    strOooOoo0 = sbOooOo0O.toString();
                } else {
                    strOooOoo0 = OooOo.OooOoo0(strOooOoo04, "none");
                }
                String strOooOoo05 = OooOo.OooOoo0(strOooOoo0, ", n: ");
                if (this.next[iIndexOf] != -1) {
                    StringBuilder sbOooOo0O2 = OooOo.OooOo0O(strOooOoo05);
                    sbOooOo0O2.append(this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]]);
                    strOooOoo02 = sbOooOo0O2.toString();
                } else {
                    strOooOoo02 = OooOo.OooOoo0(strOooOoo05, "none");
                }
                strOooOoo03 = OooOo.OooOoo0(strOooOoo02, C3034d9.i.f8179e);
            }
        }
        return OooOo.OooOoo0(strOooOoo03, " }");
    }
