...
public class BarrierReference extends HelperReference {
    ...
    public static /* synthetic */ class C01741 {
        ...
        static final /* synthetic */ int[] f39xf452c4aa;
        ...
        static {
            ...
            try {
                f39xf452c4aa[State.Direction.START.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f39xf452c4aa[State.Direction.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f39xf452c4aa[State.Direction.END.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f39xf452c4aa[State.Direction.TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f39xf452c4aa[State.Direction.BOTTOM.ordinal()] = 6;
    ...
    public void apply() {
        getHelperWidget();
        int i = 0;
        switch (C01741.f39xf452c4aa[this.mDirection.ordinal()]) {
            case 3:
            case 4:
                i = 1;
                break;
