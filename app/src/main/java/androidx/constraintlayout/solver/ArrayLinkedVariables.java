...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z) {
        ...
        if (f <= (-f2) || f >= f2) {
            ...
            if (i == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f37id;
            ...
            this.mArrayIndices[length] = solverVariable.f37id;
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            if (this.mArrayIndices[i] == solverVariable.f37id) {
                return true;
            }
            i = this.mArrayNextIndices[i];
        }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i != -1 && i2 < this.currentSize; i2++) {
            ...
            sbOooOo0O.append(this.mArrayValues[i]);
            sbOooOo0O.append(" : ");
            StringBuilder sbOooOo0O2 = OooOo.OooOo0O(sbOooOo0O.toString());
            sbOooOo0O2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
