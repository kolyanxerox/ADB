...
public class ArrayRow implements LinearSystem.Row {
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                ...
                if ((zArr == null || !zArr[variable.f37id]) && variable != solverVariable && (((type = variable.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
    ...
    */
    public java.lang.String toReadableString() {
        ...
        L17:
            java.lang.String r1 = " = "
            java.lang.String r0 = OooO0oO.OooOo.OooOoo0(r0, r1)
        ...
        L76:
            ...
            if (r1 != 0) goto L81
            java.lang.String r0 = OooO0oO.OooOo.OooOoo0(r0, r6)
            goto L98
        L81:
    ...
    public void updateFromSystem(LinearSystem linearSystem) {
        ...
        while (!z) {
            ...
            if (this.variablesToUpdate.size() > 0) {
                ArrayList<SolverVariable> arrayList = this.variablesToUpdate;
                ...
                while (i2 < size) {
                    ...
                    if (solverVariable2.isFinalValue) {
                        ...
                        updateFromRow(linearSystem.mRows[solverVariable2.definitionId], true);
                    }
                }
