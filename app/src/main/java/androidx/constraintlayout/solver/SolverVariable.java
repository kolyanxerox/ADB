...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String str) {
        if (str != null) {
            ...
            sbOooOo0O.append(uniqueErrorId);
            return sbOooOo0O.toString();
        }
        int i = C01711.$SwitchMap$androidx$constraintlayout$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    public String strengthsToString() {
        ...
        while (i < this.strengthVector.length) {
            ...
            strOooOoo0 = i < fArr.length - 1 ? OooOo.OooOoo0(string, ", ") : OooOo.OooOoo0(string, "] ");
            i++;
        }
        if (z) {
            strOooOoo0 = OooOo.OooOoo0(strOooOoo0, " (-)");
        }
        return z2 ? OooOo.OooOoo0(strOooOoo0, " (*)") : strOooOoo0;
    }
