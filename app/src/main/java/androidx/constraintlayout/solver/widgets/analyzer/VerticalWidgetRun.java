...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public static /* synthetic */ class C01811 {
        ...
        static final /* synthetic */ int[] f49xbf6f0c8e;
        ...
        static {
            ...
            try {
                f49xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int dimensionRatio2;
        int i = C01811.f49xbf6f0c8e[this.mRunType.ordinal()];
        if (i == 1) {
