...
public abstract class WidgetRun implements Dependency {
    ...
    public static /* synthetic */ class C01821 {
        ...
        static {
            ...
            try {
                f50x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f50x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C01821.f50x4c44d048[constraintAnchor2.mType.ordinal()];
        if (i == 1) {
    ...
    public long wrapSize(int i) {
        ...
        return isCenterConnection() ? j + (this.start.margin - this.end.margin) : i == 0 ? j + this.start.margin : j - this.end.margin;
    }
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C01821.f50x4c44d048[constraintAnchor2.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
