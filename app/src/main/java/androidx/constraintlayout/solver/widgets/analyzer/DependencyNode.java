...
public class DependencyNode implements Dependency {
    ...
    public String name() {
        ...
        Type type = this.type;
        StringBuilder sbOooOo = OooOo.OooOo((type == Type.LEFT || type == Type.RIGHT) ? OooOo.OooOoo0(debugName, "_HORIZONTAL") : OooOo.OooOoo0(debugName, "_VERTICAL"), TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER);
        sbOooOo.append(this.type.name());
