...
public class PriorityGoalRow extends ArrayRow {
    ...
    public class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f37id - ((SolverVariable) obj).f37id;
        }
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i = 0; i < 9; i++) {
                    ...
                    sbOooOo0O.append(this.variable.goalStrengthVector[i]);
                    sbOooOo0O.append(StringUtils.SPACE);
                    string = sbOooOo0O.toString();
                }
            }
            StringBuilder sbOooOo = OooOo.OooOo(string, "] ");
            sbOooOo.append(this.variable);
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i3].f37id > solverVariable.f37id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f37id - solverVariable3.f37id;
                }
            });
    ...
    */
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numGoals; i++) {
            ...
            StringBuilder sbOooOo0O = OooOo.OooOo0O(string);
            sbOooOo0O.append(this.accessor);
            sbOooOo0O.append(StringUtils.SPACE);
            string = sbOooOo0O.toString();
        }
        return string;
