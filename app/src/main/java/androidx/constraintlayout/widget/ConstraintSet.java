...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0189R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0189R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0189R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0189R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0189R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintLeft_creator, UNUSED);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintTop_creator, UNUSED);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintRight_creator, UNUSED);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBottom_creator, UNUSED);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintBaseline_creator, UNUSED);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0189R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintCircle, CIRCLE);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintWidth_percent, WIDTH_PERCENT);
            mapToConstant.append(C0189R.styleable.Layout_layout_constraintHeight_percent, HEIGHT_PERCENT);
            mapToConstant.append(C0189R.styleable.Layout_chainUseRtl, CHAIN_USE_RTL);
            mapToConstant.append(C0189R.styleable.Layout_barrierDirection, BARRIER_DIRECTION);
            mapToConstant.append(C0189R.styleable.Layout_barrierMargin, BARRIER_MARGIN);
            mapToConstant.append(C0189R.styleable.Layout_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
            mapToConstant.append(C0189R.styleable.Layout_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0189R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0189R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0189R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0189R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0189R.styleable.Motion_animate_relativeTo, 5);
            mapToConstant.append(C0189R.styleable.Motion_motionStagger, 6);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Motion);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0189R.styleable.PropertySet_android_alpha) {
                    this.alpha = typedArrayObtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0189R.styleable.PropertySet_android_visibility) {
                    this.visibility = typedArrayObtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0189R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = typedArrayObtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0189R.styleable.PropertySet_motionProgress) {
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0189R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0189R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0189R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0189R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0189R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0189R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0189R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0189R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0189R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0189R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0189R.styleable.Transform_android_elevation, 11);
        }
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Transform);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        mapToConstant = sparseIntArray;
        sparseIntArray.append(C0189R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0189R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0189R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0189R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0189R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintLeft_creator, UNUSED);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTop_creator, UNUSED);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintRight_creator, UNUSED);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBottom_creator, UNUSED);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintBaseline_creator, UNUSED);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0189R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0189R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0189R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0189R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0189R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0189R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0189R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0189R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0189R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0189R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0189R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0189R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0189R.styleable.Constraint_android_translationY, TRANSLATION_Y);
        mapToConstant.append(C0189R.styleable.Constraint_android_translationZ, TRANSLATION_Z);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_default, WIDTH_DEFAULT);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_default, HEIGHT_DEFAULT);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_max, WIDTH_MAX);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_max, HEIGHT_MAX);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_min, WIDTH_MIN);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_min, HEIGHT_MIN);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintCircle, CIRCLE);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0189R.styleable.Constraint_animate_relativeTo, 64);
        mapToConstant.append(C0189R.styleable.Constraint_transitionEasing, TRANSITION_EASING);
        mapToConstant.append(C0189R.styleable.Constraint_drawPath, DRAW_PATH);
        mapToConstant.append(C0189R.styleable.Constraint_transitionPathRotate, TRANSITION_PATH_ROTATE);
        mapToConstant.append(C0189R.styleable.Constraint_motionStagger, MOTION_STAGGER);
        mapToConstant.append(C0189R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0189R.styleable.Constraint_motionProgress, PROGRESS);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintWidth_percent, WIDTH_PERCENT);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintHeight_percent, HEIGHT_PERCENT);
        mapToConstant.append(C0189R.styleable.Constraint_chainUseRtl, CHAIN_USE_RTL);
        mapToConstant.append(C0189R.styleable.Constraint_barrierDirection, BARRIER_DIRECTION);
        mapToConstant.append(C0189R.styleable.Constraint_barrierMargin, BARRIER_MARGIN);
        mapToConstant.append(C0189R.styleable.Constraint_constraint_referenced_ids, CONSTRAINT_REFERENCED_IDS);
        mapToConstant.append(C0189R.styleable.Constraint_barrierAllowsGoneWidgets, BARRIER_ALLOWS_GONE_WIDGETS);
        mapToConstant.append(C0189R.styleable.Constraint_pathMotionArc, PATH_MOTION_ARC);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constraintTag, CONSTRAINT_TAG);
        mapToConstant.append(C0189R.styleable.Constraint_visibilityMode, VISIBILITY_MODE);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constrainedWidth, CONSTRAINED_WIDTH);
        mapToConstant.append(C0189R.styleable.Constraint_layout_constrainedHeight, CONSTRAINED_HEIGHT);
    }
    ...
    private int[] convertReferenceString(View view, String str) throws IllegalAccessException, IllegalArgumentException {
        ...
        while (i < strArrSplit.length) {
            ...
            try {
                iIntValue = C0189R.id.class.getField(strTrim).getInt(null);
            } catch (Exception unused) {
                iIntValue = 0;
            }
            if (iIntValue == 0) {
                iIntValue = context.getResources().getIdentifier(strTrim, C3007ch.f7763x, context.getPackageName());
            }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.Constraint);
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index != C0189R.styleable.Constraint_android_id && C0189R.styleable.Constraint_android_layout_marginStart != index && C0189R.styleable.Constraint_android_layout_marginEnd != index) {
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(OooOo.OooOOOo(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(OooOo.OooOOOo(new StringBuilder("right to "), sideToString(i4), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(OooOo.OooOOOo(sb, sideToString(i4), " unknown"));
        }
    }
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < strArrSplit.length; i++) {
            String[] strArrSplit2 = strArrSplit[i].split(C3034d9.i.f8173b);
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < strArrSplitString.length; i++) {
            String[] strArrSplit = strArrSplitString[i].split(C3034d9.i.f8173b);
    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m13509clone());
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
