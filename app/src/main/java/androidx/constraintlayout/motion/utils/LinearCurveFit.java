    ...
    */
    ...
    public void getPos(double d, float[] fArr) {
        ...
        while (i4 < i3) {
            if (d == this.f27mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f28mY[i4][i5];
                }
            }
            double[] dArr2 = this.f27mT;
            int i6 = i4 + 1;
