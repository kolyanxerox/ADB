...
class TouchResponse {
    ...
    public class ViewOnTouchListenerC01681 implements View.OnTouchListener {
        public ViewOnTouchListenerC01681() {
        }
    ...
    public class C01692 implements NestedScrollView.OnScrollChangeListener {
        public C01692() {
        }
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0189R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = typedArray.getResourceId(index, this.mTouchAnchorId);
            } else if (index == C0189R.styleable.OnSwipe_touchAnchorSide) {
            ...
            } else if (index == C0189R.styleable.OnSwipe_dragDirection) {
            ...
            } else if (index == C0189R.styleable.OnSwipe_maxVelocity) {
                this.mMaxVelocity = typedArray.getFloat(index, this.mMaxVelocity);
            } else if (index == C0189R.styleable.OnSwipe_maxAcceleration) {
                this.mMaxAcceleration = typedArray.getFloat(index, this.mMaxAcceleration);
            } else if (index == C0189R.styleable.OnSwipe_moveWhenScrollAtTop) {
                this.mMoveWhenScrollAtTop = typedArray.getBoolean(index, this.mMoveWhenScrollAtTop);
            } else if (index == C0189R.styleable.OnSwipe_dragScale) {
                this.mDragScale = typedArray.getFloat(index, this.mDragScale);
            } else if (index == C0189R.styleable.OnSwipe_dragThreshold) {
                this.mDragThreshold = typedArray.getFloat(index, this.mDragThreshold);
            } else if (index == C0189R.styleable.OnSwipe_touchRegionId) {
                this.mTouchRegionId = typedArray.getResourceId(index, this.mTouchRegionId);
            } else if (index == C0189R.styleable.OnSwipe_onTouchUp) {
                this.mOnTouchUp = typedArray.getInt(index, this.mOnTouchUp);
            } else if (index == C0189R.styleable.OnSwipe_nestedScrollFlags) {
                this.mFlags = typedArray.getInteger(index, 0);
            } else if (index == C0189R.styleable.OnSwipe_limitBoundsTo) {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0189R.styleable.OnSwipe);
    ...
    public void setupTouch() {
        ...
        if (viewFindViewById instanceof NestedScrollView) {
            ...
            nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() { // from class: androidx.constraintlayout.motion.widget.TouchResponse.2
                ...
                @Override // androidx.core.widget.NestedScrollView.OnScrollChangeListener
                public void onScrollChange(NestedScrollView nestedScrollView2, int i2, int i22, int i3, int i4) {
                }
            });
        }
    }
