...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class RunnableC01651 implements Runnable {
        ...
        public RunnableC01651(View view) {
            view = view;
        }
    ...
    public static /* synthetic */ class C01662 {
        ...
        static {
            ...
            try {
                f33xabc7e4ac[TransitionState.SETUP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33xabc7e4ac[TransitionState.MOVING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33xabc7e4ac[TransitionState.FINISHED.ordinal()] = 4;
    ...
    public class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + MotionLayout.this.getProgress();
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            StringBuilder sbOooOo = OooOo.OooOo(str, StringUtils.SPACE);
            sbOooOo.append(Debug.getName(view));
            String string = sbOooOo.toString();
            Log.v(MotionLayout.TAG, string + "  ========= " + constraintWidgetContainer);
            int size = constraintWidgetContainer.getChildren().size();
            for (int i = 0; i < size; i++) {
                String str2 = string + C3034d9.i.f8177d + i + "] ";
                ConstraintWidget constraintWidget = constraintWidgetContainer.getChildren().get(i);
                StringBuilder sbOooOo0O = OooOo.OooOo0O(constraintWidget.mTop.mTarget != null ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "_");
                sbOooOo0O.append(constraintWidget.mBottom.mTarget != null ? "B" : "_");
                StringBuilder sbOooOo0O2 = OooOo.OooOo0O(sbOooOo0O.toString());
                sbOooOo0O2.append(constraintWidget.mLeft.mTarget != null ? "L" : "_");
                StringBuilder sbOooOo0O3 = OooOo.OooOo0O(sbOooOo0O2.toString());
                sbOooOo0O3.append(constraintWidget.mRight.mTarget != null ? "R" : "_");
                String string2 = sbOooOo0O3.toString();
                View view2 = (View) constraintWidget.getCompanionWidget();
                String name = Debug.getName(view2);
                if (view2 instanceof TextView) {
                    StringBuilder sbOooOo2 = OooOo.OooOo(name, "(");
                    sbOooOo2.append((Object) ((TextView) view2).getText());
                    sbOooOo2.append(")");
                    name = sbOooOo2.toString();
                }
                Log.v(MotionLayout.TAG, str2 + "  " + name + StringUtils.SPACE + constraintWidget + StringUtils.SPACE + string2);
            }
            Log.v(MotionLayout.TAG, string + " done. ");
        }

        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            StringBuilder sbOooOo0O = OooOo.OooOo0O(StringUtils.SPACE.concat(layoutParams.startToStart != -1 ? "SS" : "__"));
            sbOooOo0O.append(layoutParams.startToEnd != -1 ? "|SE" : "|__");
            StringBuilder sbOooOo0O2 = OooOo.OooOo0O(sbOooOo0O.toString());
            sbOooOo0O2.append(layoutParams.endToStart != -1 ? "|ES" : "|__");
            StringBuilder sbOooOo0O3 = OooOo.OooOo0O(sbOooOo0O2.toString());
            sbOooOo0O3.append(layoutParams.endToEnd != -1 ? "|EE" : "|__");
            StringBuilder sbOooOo0O4 = OooOo.OooOo0O(sbOooOo0O3.toString());
            sbOooOo0O4.append(layoutParams.leftToLeft != -1 ? "|LL" : "|__");
            StringBuilder sbOooOo0O5 = OooOo.OooOo0O(sbOooOo0O4.toString());
            sbOooOo0O5.append(layoutParams.leftToRight != -1 ? "|LR" : "|__");
            StringBuilder sbOooOo0O6 = OooOo.OooOo0O(sbOooOo0O5.toString());
            sbOooOo0O6.append(layoutParams.rightToLeft != -1 ? "|RL" : "|__");
            StringBuilder sbOooOo0O7 = OooOo.OooOo0O(sbOooOo0O6.toString());
            sbOooOo0O7.append(layoutParams.rightToRight != -1 ? "|RR" : "|__");
            StringBuilder sbOooOo0O8 = OooOo.OooOo0O(sbOooOo0O7.toString());
            sbOooOo0O8.append(layoutParams.topToTop != -1 ? "|TT" : "|__");
            StringBuilder sbOooOo0O9 = OooOo.OooOo0O(sbOooOo0O8.toString());
            sbOooOo0O9.append(layoutParams.topToBottom != -1 ? "|TB" : "|__");
            StringBuilder sbOooOo0O10 = OooOo.OooOo0O(sbOooOo0O9.toString());
            sbOooOo0O10.append(layoutParams.bottomToTop != -1 ? "|BT" : "|__");
            StringBuilder sbOooOo0O11 = OooOo.OooOo0O(sbOooOo0O10.toString());
            sbOooOo0O11.append(layoutParams.bottomToBottom != -1 ? "|BB" : "|__");
            Log.v(MotionLayout.TAG, str + sbOooOo0O11.toString());
        }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintAnchor != null) {
                strConcat = RequestConfiguration.MAX_AD_CONTENT_RATING_T.concat(constraintAnchor.mType == ConstraintAnchor.Type.TOP ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "B");
            } else {
                strConcat = "__";
            }
            sb.append(strConcat);
            StringBuilder sbOooOo0O = OooOo.OooOo0O(sb.toString());
            ...
            sbOooOo0O3.append(strConcat4);
            Log.v(MotionLayout.TAG, str + sbOooOo0O3.toString() + " ---  " + constraintWidget);
        }
    ...
    public static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f34me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f34me.tracker = VelocityTracker.obtain();
            return f34me;
        }
    ...
    private void fireTransitionChange() {
        ...
        if (this.mListenerState != -1) {
            ...
            if (arrayList2 != null) {
                ...
                int i2 = 0;
                while (i2 < size) {
                    TransitionListener transitionListener2 = arrayList2.get(i2);
                    i2++;
                    transitionListener2.onTransitionStarted(this, this.mBeginState, this.mEndState);
                }
            }
        ...
        if (transitionListener3 != null) {
            transitionListener3.onTransitionChange(this, this.mBeginState, this.mEndState, f);
        }
        ArrayList<TransitionListener> arrayList3 = this.mTransitionListeners;
        if (arrayList3 != null) {
            int size2 = arrayList3.size();
            while (i < size2) {
                TransitionListener transitionListener4 = arrayList3.get(i);
                i++;
                transitionListener4.onTransitionChange(this, this.mBeginState, this.mEndState, this.mTransitionPosition);
            }
        }
        this.mIsAnimating = true;
    }
    ...
    private void fireTransitionStarted(MotionLayout motionLayout, int i, int i2) {
        ...
        if (arrayList != null) {
            ...
            int i3 = 0;
            while (i3 < size) {
                TransitionListener transitionListener2 = arrayList.get(i3);
                i3++;
                transitionListener2.onTransitionStarted(motionLayout, i, i2);
            }
        }
    }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0189R.styleable.MotionLayout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0189R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, typedArrayObtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C0189R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = typedArrayObtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C0189R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = typedArrayObtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C0189R.styleable.MotionLayout_applyMotionScene) {
                    z = typedArrayObtainStyledAttributes.getBoolean(index, z);
                } else if (index == C0189R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = typedArrayObtainStyledAttributes.getBoolean(index, false) ? 2 : 0;
                    }
                } else if (index == C0189R.styleable.MotionLayout_motionDebug) {
    ...
    private void processTransitionCompleted() {
        ...
        while (i < size) {
            ...
            if (arrayList3 != null) {
                ...
                int i2 = 0;
                while (i2 < size2) {
                    TransitionListener transitionListener2 = arrayList3.get(i2);
                    i2++;
                    transitionListener2.onTransitionCompleted(this, num2.intValue());
                }
            }
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder sbOooOo0O = OooOo.OooOo0O(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ");
            sbOooOo0O.append(Debug.getState(this, this.mEndState));
            sbOooOo0O.append(" (progress: ");
            sbOooOo0O.append(((int) (getProgress() * 1000.0f)) / 10.0f);
            sbOooOo0O.append(" ) state=");
            int i = this.mCurrentState;
            sbOooOo0O.append(i == -1 ? AdError.UNDEFINED_DOMAIN : Debug.getState(this, i));
    ...
    public void fireTrigger(int i, boolean z, float f) {
        ...
        if (arrayList != null) {
            ...
            int i2 = 0;
            while (i2 < size) {
                TransitionListener transitionListener2 = arrayList.get(i2);
                i2++;
                transitionListener2.onTransitionTrigger(this, i, z, f);
            }
        }
    }
    ...
    public void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) {
        ...
        Log.w(TAG, "WARNING could not find view id " + (viewById == null ? OooOo.OooO0o(i, "") : viewById.getContext().getResources().getResourceName(i)));
    }
            ...
            if (transition2.getTouchResponse() != null && (this.mScene.mCurrentTransition.getTouchResponse().getFlags() & 1) != 0) {
                ...
                if ((f2 <= 0.0f && progressDirection < 0.0f) || (f2 >= 1.0f && progressDirection > 0.0f)) {
                    ...
                    view.post(new Runnable() { // from class: androidx.constraintlayout.motion.widget.MotionLayout.1
                        ...
                        public RunnableC01651(View view2) {
                            view = view2;
                        }
    ...
    public void setState(TransitionState transitionState) {
        ...
        int i = C01662.f33xabc7e4ac[transitionState3.ordinal()];
        if (i != 1 && i != 2) {
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (id == -1) {
                StringBuilder sbOooOoO0 = OooOo.OooOoO0("CHECK: ", name, " ALL VIEWS SHOULD HAVE ID's ");
                sbOooOoO0.append(childAt.getClass().getName());
                sbOooOoO0.append(" does not!");
                Log.w(TAG, sbOooOoO0.toString());
            }
            if (constraintSet.getConstraint(id) == null) {
                StringBuilder sbOooOoO02 = OooOo.OooOoO0("CHECK: ", name, " NO CONSTRAINTS for ");
                sbOooOoO02.append(Debug.getName(childAt));
                Log.w(TAG, sbOooOoO02.toString());
            }
        }
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (constraintSet.getHeight(i4) == -1) {
                Log.w(TAG, OooOo.OooOO0o("CHECK: ", name, "(", name2, ") no LAYOUT_HEIGHT"));
            }
