...
public final class PackageManagerCompat {
    ...
    public static OooOOO getUnusedAppRestrictionsStatus(Context context) {
        ...
        resolvableFutureCreate.addListener(new Runnable() { // from class: androidx.core.content.OooO
