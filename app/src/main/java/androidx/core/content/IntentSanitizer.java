...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new OooO0o(2);
        private Predicate<Uri> mAllowedData = new OooO0o(3);
        private Predicate<String> mAllowedTypes = new OooO0o(4);
        private Predicate<String> mAllowedCategories = new OooO0o(5);
        private Predicate<String> mAllowedPackages = new OooO0o(6);
        private Predicate<ComponentName> mAllowedComponents = new OooO0o(7);
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private boolean mAllowClipDataText = false;
        private Predicate<Uri> mAllowedClipDataUri = new OooO0o(8);
        private Predicate<ClipData> mAllowedClipData = new OooO0o(9);
        ...
        public Builder allowAction(String str) {
            ...
            allowAction(new OooO0O0(str, 1));
            return this;
        }

        public Builder allowAnyComponent() {
            this.mAllowAnyComponent = true;
            this.mAllowedComponents = new OooO0o(0);
            return this;
        }
        ...
        public Builder allowCategory(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new OooO0O0(str, 1));
        }

        public Builder allowClipData(Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m17or(predicate);
            return this;
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new OooO0O0(str, 5));
            return this;
        }
        ...
        public Builder allowPackage(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new OooO0O0(str, 1));
        }
        ...
        public Builder allowType(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType(new OooO0O0(str, 1));
        }
        ...
        public <T> Builder allowExtra(String str, Class<T> cls, Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new androidx.core.util.OooO00o(cls, predicate));
        }
        ...
        public Builder allowAction(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedActions = this.mAllowedActions.m17or(predicate);
            return this;
        }

        public Builder allowCategory(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m17or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m17or(predicate);
            return this;
        }

        public Builder allowPackage(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m17or(predicate);
            return this;
        }

        public Builder allowType(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m17or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            Preconditions.checkNotNull(str);
            Preconditions.checkNotNull(predicate);
            Predicate<Object> oooO0o = this.mAllowedExtras.get(str);
            if (oooO0o == null) {
                oooO0o = new OooO0o(1);
            }
            this.mAllowedExtras.put(str, oooO0o.m17or(predicate));
            return this;
        }
    }

    public /* synthetic */ IntentSanitizer(C02061 c02061) {
        this();
    }
    ...
    */
    public static void sanitizeClipData(android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate<android.content.ClipData> r9, boolean r10, androidx.core.util.Predicate<android.net.Uri> r11, androidx.core.util.Consumer<java.lang.String> r12) {
        ...
        L35:
            ...
            java.lang.StringBuilder r3 = OooO0oO.OooOo.OooOOo0(r0, r3, r4)
        ...
        L52:
            ...
            if (r6 == 0) goto L94
            java.lang.StringBuilder r4 = OooO0oO.OooOo.OooOOo0(r0, r5, r4)
    ...
    public Intent sanitizeByFiltering(Intent intent) {
        return sanitize(intent, new OooO00o(1));
    }

    public Intent sanitizeByThrowing(Intent intent) {
        return sanitize(intent, new OooO00o(0));
    }
