...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) throws IOException {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(OooOo.OooOO0("Failed to find configured root that contains ", canonicalPath));
                }
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, ProviderInfo providerInfo, int i) {
        if (providerInfo == null) {
            throw new IllegalArgumentException(OooOo.OooOO0("Couldn't find meta-data for provider with authority ", str));
        }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(OooOo.OooOO0("Invalid mode: ", str));
    }
