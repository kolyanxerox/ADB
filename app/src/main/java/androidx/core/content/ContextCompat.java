...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            map.put(BluetoothManager.class, C3896z8.f12932d);
            map.put(DisplayManager.class, C3034d9.h.f8099d);
            ...
            map.put(StorageManager.class, C3034d9.a.f7924k);
            ...
            map.put(WifiManager.class, C3896z8.f12930b);
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(OooOo.OooOO0O("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
