...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new OooO00o();
    ...
    private static String makeUrl(String str, String[] strArr, Matcher matcher, Linkify.TransformFilter transformFilter) {
        ...
        while (true) {
            ...
            if (string.regionMatches(true, 0, str2, 0, str2.length())) {
                ...
                if (!string.regionMatches(false, 0, str2, 0, str2.length())) {
                    StringBuilder sbOooOo0O = OooOo.OooOo0O(str2);
                    sbOooOo0O.append(string.substring(str2.length()));
        ...
        return (z || strArr.length <= 0) ? string : OooOo.OooOOOo(new StringBuilder(), strArr[0], string);
    }
