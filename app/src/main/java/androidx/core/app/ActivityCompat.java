...
public class ActivityCompat extends ContextCompat {
    ...
    public class RunnableC02001 implements Runnable {
        ...
        public RunnableC02001(String[] strArr, Activity activity, int i) {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i)) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (TextUtils.isEmpty(strArr[i2])) {
                    throw new IllegalArgumentException(OooOo.OooOOOo(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                }
