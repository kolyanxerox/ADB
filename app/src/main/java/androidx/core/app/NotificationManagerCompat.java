...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public void send(android.support.v4.app.OooO0OO oooO0OO) throws RemoteException {
            oooO0OO.notify(this.packageName, this.f57id, this.tag, this.notif);
        }
        ...
        public String toString() {
            ...
            sb.append(", id:");
            sb.append(this.f57id);
            sb.append(", tag:");
            return OooOo.OooOOOo(sb, this.tag, C3034d9.i.f8179e);
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        public static class ListenerRecord {
            final ComponentName componentName;
            android.support.v4.app.OooO0OO service;
            boolean bound = false;
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.service = android.support.v4.app.OooO0O0.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
    ...
    public interface Task {
        void send(android.support.v4.app.OooO0OO oooO0OO) throws RemoteException;
    }
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelOooO0oO = OooO0OO.OooO00o.OooO0oO(it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelOooO0oO)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelOooO0oO)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelOooO0oO));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        while (it.hasNext()) {
            NotificationChannelGroup notificationChannelGroupOooOO0 = OooO0OO.OooO00o.OooOO0(it.next());
            if (Api26Impl.getId(notificationChannelGroupOooOO0).equals(str)) {
                return notificationChannelGroupOooOO0;
            }
        }
        return null;
    }
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupOooOO0));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupOooOO0, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(OooO0OO.OooO00o.OooO0oO(it.next())));
                }
                return arrayList;
            }
        }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(android.support.v4.app.OooO0OO oooO0OO) throws RemoteException {
            if (this.all) {
                oooO0OO.cancelAll(this.packageName);
            } else {
                oooO0OO.cancel(this.packageName, this.f56id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f56id + ", tag:" + this.tag + ", all:" + this.all + C3034d9.i.f8179e;
        }
