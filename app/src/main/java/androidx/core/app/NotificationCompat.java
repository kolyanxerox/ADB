...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m13510clone() {
    ...
    public static final class BubbleMetadata {
        ...
        public /* synthetic */ BubbleMetadata(PendingIntent pendingIntent, PendingIntent pendingIntent2, IconCompat iconCompat, int i, int i2, int i3, String str, C02051 c02051) {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    i++;
                    addPerson(Person.fromAndroidPerson(OooO0o.OooO00o.OooO0o(obj)));
                }
            }
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            ...
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0193R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0193R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0193R.string.call_notification_screening_text);
        }
        ...
        private Action makeAnswerAction() {
            int i = C0193R.drawable.ic_call_answer_video;
            int i2 = C0193R.drawable.ic_call_answer;
            PendingIntent pendingIntent = this.mAnswerIntent;
            if (pendingIntent == null) {
                return null;
            }
            boolean z = this.mIsVideo;
            return makeAction(z ? i : i2, z ? C0193R.string.call_notification_answer_video_action : C0193R.string.call_notification_answer_action, this.mAnswerButtonColor, C0193R.color.call_notification_answer_color, pendingIntent);
        }

        private Action makeNegativeAction() {
            int i = C0193R.drawable.ic_call_decline;
            PendingIntent pendingIntent = this.mDeclineIntent;
            return pendingIntent == null ? makeAction(i, C0193R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0193R.color.call_notification_decline_color, this.mHangUpIntent) : makeAction(i, C0193R.string.call_notification_decline_action, this.mDeclineButtonColor, C0193R.color.call_notification_decline_color, pendingIntent);
        }
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(OooO0o.OooO00o.OooO0o0(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) throws Resources.NotFoundException {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0193R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0193R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(C0193R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C0193R.id.actions, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0193R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0193R.layout.notification_action_tombstone : C0193R.layout.notification_action);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0193R.id.action_image, createColoredBitmap(iconCompat, C0193R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0193R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0193R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0193R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() throws Resources.NotFoundException {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0193R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0193R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0193R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0193R.id.title, 8);
            remoteViews.setViewVisibility(C0193R.id.text2, 8);
            remoteViews.setViewVisibility(C0193R.id.text, 8);
        }
        ...
        */
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) throws Resources.NotFoundException {
            ...
            remoteViews.removeAllViews(C0193R.id.notification_main_column);
            remoteViews.addView(C0193R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0193R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C0193R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m13511clone() {
            WearableExtender wearableExtender = new WearableExtender();
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size) {
                    Object obj = parcelableArrayList.get(i);
                    i++;
                    arrayList.add(Person.fromAndroidPerson(OooO0o.OooO00o.OooO0o(obj)));
                }
            }
        } else {
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) throws Resources.NotFoundException {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0193R.dimen.compat_notification_large_icon_max_width);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0193R.dimen.compat_notification_large_icon_max_height);
