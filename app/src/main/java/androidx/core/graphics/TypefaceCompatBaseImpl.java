...
class TypefaceCompatBaseImpl {
    ...
    public class C02141 implements StyleExtractor<FontsContractCompat.FontInfo> {
        public C02141() {
        }
    ...
    public class C02152 implements StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry> {
        public C02152() {
        }
    ...
    public class C02163 implements StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry> {
        public C02163() {
        }
    ...
    private static <T> T findBestFont(T[] tArr, int i, StyleExtractor<T> styleExtractor) {
        return (T) findBestFont(tArr, (i & 1) == 0 ? CommonGatewayClient.CODE_400 : IronSourceError.ERROR_NT_LOAD_AFTER_INIT_FAILED, (i & 2) != 0, styleExtractor);
    }
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i, boolean z) throws NoSuchFieldException, SecurityException {
