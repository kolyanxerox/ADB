...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static BoundsCompat computeAnimationBounds(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i) {
            ...
            return new BoundsCompat(Insets.m9of(Math.min(insets.left, insets2.left), Math.min(insets.top, insets2.top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m9of(Math.max(insets.left, insets2.left), Math.max(insets.top, insets2.top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        public static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(C0193R.id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }

        public static Callback getCallback(View view) {
            Object tag = view.getTag(C0193R.id.tag_window_insets_animation_callback);
        ...
        public static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0193R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0193R.id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0193R.id.tag_window_insets_animation_callback, onApplyWindowInsetsListenerCreateProxyListener);
            if (tag == null) {
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationOooOO0O = OooO0O0.OooO00o.OooOO0O(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationOooOO0O);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationOooOO0O.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            ...
            return OooO0O0.OooO00o.OooO(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
        ...
        public Impl30(int i, Interpolator interpolator, long j) {
            this(OooO0O0.OooO00o.OooOO0(i, interpolator, j));
        }
    }
