...
public final class ViewPropertyAnimatorCompat {
    ...
    public static class Api21Impl {
        ...
        /* renamed from: z */
        public static ViewPropertyAnimator m22z(ViewPropertyAnimator viewPropertyAnimator, float f) {
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(final ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener) {
        ...
        if (view != null) {
            view.animate().setUpdateListener(viewPropertyAnimatorUpdateListener != null ? new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.OooOo
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m19x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m20y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m21z(float f) {
        View view = this.mView.get();
        if (view != null) {
            Api21Impl.m22z(view.animate(), f);
        }
        return this;
    }
