...
public final class SoftwareKeyboardControllerCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        public void show() {
            ...
            viewFindViewById.post(new OooOO0O(viewFindViewById, 0));
        }
    }
    ...
    public static class Impl30 extends Impl20 {
        ...
        /* JADX WARN: Type inference failed for: r3v0, types: [androidx.core.view.OooOOO0] */
        ...
        public void hide() {
            ...
            ?? r3 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.OooOOO0
