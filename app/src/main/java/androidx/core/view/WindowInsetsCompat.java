...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat windowInsetsCompatBuild = new Builder().setStableInsets(Insets.m10of(rect)).setSystemWindowInsets(Insets.m10of(rect2)).build();
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsetsIgnoringVisibility(int i, Insets insets) throws IllegalArgumentException {
    ...
    public static class Impl20 extends Impl {
        ...
        public void copyRootViewBounds(View view) throws IllegalAccessException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        public Insets getInsetsForType(int i, boolean z) {
            ...
            int i2;
            if (i == 1) {
                return z ? Insets.m9of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0) : Insets.m9of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m9of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m9of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i != 8) {
                if (i == 16) {
                ...
                return displayCutout != null ? Insets.m9of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom()) : Insets.NONE;
            }
            ...
            if (i3 > rootStableInsets2.bottom) {
                return Insets.m9of(0, 0, 0, i3);
            }
            Insets insets = this.mRootViewVisibleInsets;
            return (insets == null || insets.equals(Insets.NONE) || (i2 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.m9of(0, 0, 0, i2);
        }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i) {
            ...
            throw new IllegalArgumentException(OooO0oO.OooOo.OooO0o(i, "type needs to be >= FIRST and <= LAST, type="));
        }
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m9of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m9of(i, i2, i3, i4)).build();
    }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = Oooo000.OooO0oO();
        }
        ...
        public BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderOooO0oO;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderOooO0oO = Oooo000.OooO0oo(windowInsets);
            } else {
                builderOooO0oO = Oooo000.OooO0oO();
            }
            this.mPlatBuilder = builderOooO0oO;
        }
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m10of(rect)).build();
    }
