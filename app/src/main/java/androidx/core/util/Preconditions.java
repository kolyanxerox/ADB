...
public final class Preconditions {
    ...
    public static float checkArgumentFinite(float f, String str) {
        if (Float.isNaN(f)) {
            throw new IllegalArgumentException(OooOo.OooOoo0(str, " must not be NaN"));
        }
        if (Float.isInfinite(f)) {
            throw new IllegalArgumentException(OooOo.OooOoo0(str, " must not be infinite"));
        }
        return f;
    }
    ...
    public static long checkArgumentInRange(long j, long j2, long j3, String str) {
        if (j < j2) {
            ...
            sb.append(j2);
            sb.append(", ");
            throw new IllegalArgumentException(OooOo.OooOOOO(sb, j3, "] (too low)"));
        }
        if (j <= j3) {
            return j;
        }
        ...
        sb2.append(j2);
        sb2.append(", ");
        throw new IllegalArgumentException(OooOo.OooOOOO(sb2, j3, "] (too high)"));
    }
