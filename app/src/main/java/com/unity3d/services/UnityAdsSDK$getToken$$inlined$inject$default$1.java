...
public final class UnityAdsSDK$getToken$$inlined$inject$default$1 extends Oooo000 implements OooO0O0 {
    ...
    public final GetGameId invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(GetGameId.class));
    }
}
