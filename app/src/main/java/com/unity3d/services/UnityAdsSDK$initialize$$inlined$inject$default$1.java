...
public final class UnityAdsSDK$initialize$$inlined$inject$default$1 extends Oooo000 implements OooO0O0 {
    ...
    public final ShouldAllowInitialization invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(ShouldAllowInitialization.class));
    }
}
