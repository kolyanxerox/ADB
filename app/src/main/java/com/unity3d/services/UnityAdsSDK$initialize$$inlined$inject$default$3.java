...
public final class UnityAdsSDK$initialize$$inlined$inject$default$3 extends Oooo000 implements OooO0O0 {
    ...
    public final InitializeSDK invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(InitializeSDK.class));
    }
}
