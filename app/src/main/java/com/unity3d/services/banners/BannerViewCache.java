...
public class BannerViewCache {
    ...
    public synchronized void loadScarPlayer(String str, o000O0Oo o000o0oo2, UnityBannerSize unityBannerSize) {
        BannerView bannerView = getBannerView(str);
        if (bannerView != null) {
            bannerView.loadScarPlayer(str, o000o0oo2, unityBannerSize);
        }
    }
