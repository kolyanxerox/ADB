...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$2 extends Oooo000 implements OooO0O0 {
    ...
    public final GetHeaderBiddingToken invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(GetHeaderBiddingToken.class));
    }
}
