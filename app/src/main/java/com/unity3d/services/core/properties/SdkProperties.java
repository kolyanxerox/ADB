...
public class SdkProperties {
    ...
    public static String getDefaultConfigUrl(String str) {
        ...
        sb.append(str2);
        sb.append("/webview/");
        return OooO00o.OooOOO(sb, getWebViewBranch(), "/", str, "/config.json");
    }
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    Utilities.wrapCustomerListener(new com.unity3d.services.ads.OooO00o(iUnityAdsInitializationListener, 1));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static void notifyInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                Iterator it = linkedHashSet2.iterator();
                while (it.hasNext()) {
                    Utilities.wrapCustomerListener(new o0000O0O((IUnityAdsInitializationListener) it.next(), unityAdsInitializationError, str, 2));
                }
            } catch (Throwable th) {
                throw th;
            }
