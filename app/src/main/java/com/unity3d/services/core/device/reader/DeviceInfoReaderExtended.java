...
public class DeviceInfoReaderExtended implements IDeviceInfoReader {
    ...
    public Map<String, Object> getDeviceInfoData() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        deviceInfoData.put(C3034d9.i.f8193l, Device.getModel());
        deviceInfoData.put("language", Locale.getDefault().toString());
        deviceInfoData.put(C3034d9.i.f8208t, Device.getConnectionType());
        ...
        deviceInfoData.put(C3034d9.i.f8170Y, Float.valueOf(Device.getBatteryLevel()));
