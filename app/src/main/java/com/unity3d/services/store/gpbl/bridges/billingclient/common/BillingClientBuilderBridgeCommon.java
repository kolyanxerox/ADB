...
public abstract class BillingClientBuilderBridgeCommon extends GenericBridge implements IBillingClientBuilderBridge {
    ...
    /* renamed from: com.unity3d.services.store.gpbl.bridges.billingclient.common.BillingClientBuilderBridgeCommon$1 */
    public class C43721 extends HashMap<String, Class<?>[]> {
        public C43721() throws ClassNotFoundException {
