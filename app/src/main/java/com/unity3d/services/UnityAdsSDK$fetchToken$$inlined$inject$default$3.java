...
public final class UnityAdsSDK$fetchToken$$inlined$inject$default$3 extends Oooo000 implements OooO0O0 {
    ...
    public final GetInitializationState invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(GetInitializationState.class));
    }
}
