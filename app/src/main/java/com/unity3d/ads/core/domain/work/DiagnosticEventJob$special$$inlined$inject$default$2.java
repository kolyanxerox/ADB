...
public final class DiagnosticEventJob$special$$inlined$inject$default$2 extends Oooo000 implements OooO0O0 {
    ...
    public final DiagnosticEventRequestWorkModifier invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(DiagnosticEventRequestWorkModifier.class));
    }
}
