...
public interface SendDiagnosticEvent {
    ...
    public static final String SHOW_AD_VIEWER_FULLSCREEN_INTENT_FINISHING = "native_show_ad_viewer_fullscreen_intent_finishing";
    ...
    void invoke(String str, Double d, Map<String, String> map, Map<String, Integer> map2, AdObject adObject, Integer num);
}
