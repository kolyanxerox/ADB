...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends Oooo000 implements OooO0O0 {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, o0OO00O.OooO00o(UniversalRequestDataSource.class));
    }
}
