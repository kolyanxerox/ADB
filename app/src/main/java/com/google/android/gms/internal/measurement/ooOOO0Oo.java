...
public abstract class ooOOO0Oo {

    /* renamed from: OooO00o, reason: collision with root package name */
    public static final /* synthetic */ int f26918OooO00o = 0;

    static {
        if (oO0O0Oo0.f26748OooO0o0 && oO0O0Oo0.f26746OooO0Oo) {
    ...
    */
    public static boolean OooO00o(byte[] r6, int r7, int r8) {
        /*
        L0:
            if (r7 >= r8) goto L9
            r0 = r6[r7]
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.ooOOO0Oo.OooO00o(byte[], int, int):boolean");
    }
    ...
    public static int OooO0OO(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    throw new oOo0o0oO(i6 - 1, length);
                }
    ...
    public static /* synthetic */ int OooO0Oo(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 == 0) {
            if (b <= -12) {
