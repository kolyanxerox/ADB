...
public abstract class o0OO00O {
    ...
    public static final ClassLoader f26540OooO00o = o0OO00O.class.getClassLoader();
    ...
    public static void OooO0O0(Parcel parcel, Parcelable parcelable) {
        if (parcelable == null) {
            parcel.writeInt(0);
        } else {
            parcel.writeInt(1);
    ...
    public static void OooO0Oo(Parcel parcel) {
