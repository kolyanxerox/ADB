...
public final class oo0o0Oo extends Fragment implements OooOO0O {

    /* renamed from: OooOo0o, reason: collision with root package name */
    public static final WeakHashMap f16764OooOo0o = new WeakHashMap();

    /* renamed from: OooOo0O, reason: collision with root package name */
    public final o0000O00 f16765OooOo0O = new o0000O00();

    @Override // com.google.android.gms.common.api.internal.OooOO0O
    public final void OooO00o(String str, OooOO0 oooOO0) {
        this.f16765OooOo0O.OooO(str, oooOO0);
    }

    @Override // com.google.android.gms.common.api.internal.OooOO0O
    public final OooOO0 OooO0O0(Class cls, String str) {
        return (OooOO0) cls.cast(((Map) this.f16765OooOo0O.f13929OooO0OO).get(str));
    }

    @Override // androidx.fragment.app.Fragment
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        super.dump(str, fileDescriptor, printWriter, strArr);
        Iterator it = ((Map) this.f16765OooOo0O.f13929OooO0OO).values().iterator();
        while (it.hasNext()) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.f16765OooOo0O.OooOO0(bundle);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onDestroy() {
        super.onDestroy();
        o0000O00 o0000o00 = this.f16765OooOo0O;
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        this.f16765OooOo0O.OooOO0O(bundle);
    }
