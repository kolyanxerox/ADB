...
public interface MediationNativeListener {
    ...
    void zzd(MediationNativeAdapter mediationNativeAdapter, C1451ca c1451ca);

    void zze(MediationNativeAdapter mediationNativeAdapter, C1451ca c1451ca, String str);
}
