...
public abstract class o0OO {
    ...
    public static final /* synthetic */ int f27134OooO00o = 0;

    static {
        if (o0OO0o.f27150OooO0o0 && o0OO0o.f27148OooO0Oo) {
            int i = o0oOOo.f27171OooO00o;
        }
    }

    public static /* bridge */ /* synthetic */ int OooO00o(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 == 0) {
            if (b <= -12) {
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    throw new o0OO0oO0(i6 - 1, length);
                }
    ...
    */
    public static boolean OooO0Oo(byte[] r6, int r7, int r8) {
        /*
        L0:
            if (r7 >= r8) goto L9
            r0 = r6[r7]
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.o0OO.OooO0Oo(byte[], int, int):boolean");
    }
}
