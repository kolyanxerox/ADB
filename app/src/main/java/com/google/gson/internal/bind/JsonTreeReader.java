...
public final class JsonTreeReader extends JsonReader {
    ...
    public class C24221 extends Reader implements AutoCloseable {
        @Override // java.io.Reader, java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            throw new AssertionError();
        }
    ...
    public static /* synthetic */ class C24232 {
    ...
    public void skipValue() throws IOException {
        int i = C24232.$SwitchMap$com$google$gson$stream$JsonToken[peek().ordinal()];
        if (i == 1) {
            nextName(true);
            return;
        }
