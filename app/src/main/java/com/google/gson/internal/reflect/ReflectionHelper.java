...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) throws JsonIOException, SecurityException {
        try {
            ...
            throw new JsonIOException(OooOo.OooOO0O("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e);
        }
    }
