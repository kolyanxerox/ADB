...
public class JsonReader implements Closeable, AutoCloseable {
    ...
    */
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        sbOooOo0O.append(locationString());
        throw new MalformedJsonException(sbOooOo0O.toString());
    }
    ...
    public String locationString() {
        StringBuilder sbOooOo0o = OooOo.OooOo0o(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        sbOooOo0o.append(getPath());
