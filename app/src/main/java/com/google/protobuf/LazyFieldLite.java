...
public class LazyFieldLite {
    ...
    public void writeTo(oO0000O oo0000o, int i) throws IOException {
        if (this.memoizedBytes != null) {
            ((o0000oo) oo0000o).OooO00o(i, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ((o0000oo) oo0000o).OooO00o(i, byteString);
        } else if (this.value != null) {
            ((o0000oo) oo0000o).f28210OooO00o.writeMessage(i, this.value);
        } else {
            ((o0000oo) oo0000o).OooO00o(i, ByteString.EMPTY);
        }
    }
