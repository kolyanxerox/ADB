...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, @Nullable String str, String str2) {
        C2609g.m4654a(partner, "Partner is null");
        C2609g.m4654a(webView, "WebView is null");
        if (str2 != null) {
            C2609g.m4655a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, @Nullable String str2, String str3) {
        C2609g.m4654a(partner, "Partner is null");
        C2609g.m4654a((Object) str, "OM SDK JS script content is null");
        C2609g.m4654a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C2609g.m4655a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
