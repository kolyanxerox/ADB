...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = false;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.github.superadb";
    ...
    /* renamed from: com.pairip.licensecheck.LicenseClient$1 */
    class RunnableC39211 implements Runnable {
        RunnableC39211() {
        }
    ...
    /* renamed from: com.pairip.licensecheck.LicenseClient$2 */
    class BinderC39222 extends ILicenseV2ResultListener.Stub {
        BinderC39222() {
        }

        @Override // com.pairip.licensecheck.ILicenseV2ResultListener
        public void verifyLicense(int responseCode, Bundle responsePayload) throws LicenseCheckException {
    ...
    private static final class DelayedTaskExecutor {
        ...
        /* synthetic */ DelayedTaskExecutor(LicenseClientIA licenseClientIA) {
            this();
        }
