...
public class JsonUtils {
    ...
    /* renamed from: a */
    private static List m3262a(JSONArray jSONArray, List list) {
        if (jSONArray == null) {
            return list;
        }
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i = 0; i < jSONArray.length(); i++) {
            arrayList.add(m3261a(jSONArray.get(i)));
        }
        return arrayList;
    }
    ...
    public static JSONObject deepCopy(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            ...
            try {
                ...
                C1240o.m3210l("JsonUtils", "Failed to copy over item for key '" + next + "' to JSONObject deep copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static JSONObject deserialize(String str) {
        ...
        try {
            ...
            C1240o.m3202b("JsonUtils", "Failed to deserialize into JSON: " + str, th);
            return null;
        }
    }
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve double property for key = " + str, e);
            }
        }
        return d;
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f) throws JSONException {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve float property for key = " + str, e);
            }
        }
        return f;
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve int property for key = " + str, e);
            }
        }
        return i;
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve JSON array for key = " + str, e);
            }
        }
        return jSONArray;
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve long property for key = " + str, e);
            }
        }
        return j;
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) throws JSONException {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve Object for key = " + str, e);
            }
        }
        return obj;
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i, Object obj) {
        if (jSONArray != null && jSONArray.length() > i) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve object at index " + i + " for JSON array", e);
            }
        }
        return obj;
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve string property for key = " + str, e);
            }
        }
        return str2;
    }
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            C1240o.m3202b("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e);
            return jSONObject;
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put boolean property for key = " + str, e);
            }
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put double property for key = " + str, e);
            }
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put int property for key = " + str, e);
            }
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put JSON property for key = " + str, e);
            }
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put JSONArray property for key = " + str, e);
            }
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put long property for key = " + str, e);
            }
        }
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put Object property for key = " + str, e);
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to put String property for key = " + str, e);
            }
        }
    }
    ...
    public static JSONObject shallowCopy(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            ...
            try {
                ...
                C1240o.m3210l("JsonUtils", "Failed to copy over item for key '" + next + "' to JSONObject copy");
            }
        }
        return jSONObject2;
    }
    ...
    public static <T> List<T> toList(JSONArray jSONArray) throws JSONException {
        return m3262a(jSONArray, new ArrayList());
    }
    ...
    public static Map<String, String> toStringMap(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            map.put(next, m3261a(jSONObject.get(next)).toString());
        }
        return map;
    }
    ...
    public static Map<String, Object> toStringObjectMap(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            map.put(next, m3261a(jSONObject.get(next)));
        }
        return map;
    }
    ...
    public static Map<String, String> tryToStringMap(JSONObject jSONObject) {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            try {
                Object objM3261a = m3261a(jSONObject.get(next));
                map.put(next, objM3261a != null ? objM3261a.toString() : null);
            } catch (Throwable unused) {
            }
        }
        return map;
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve JSON property for key = " + str, e);
            }
        }
        return jSONObject2;
    }
    ...
    /* renamed from: a */
    private static Object m3261a(Object obj) {
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i, JSONObject jSONObject) {
        if (jSONArray != null && i < jSONArray.length()) {
            try {
                ...
                C1240o.m3202b("JsonUtils", "Failed to retrieve JSON object from array for index = " + i, e);
            }
        }
        return jSONObject;
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str) {
        try {
            ...
            C1240o.m3202b("JsonUtils", "Failed to convert json string '" + str + "' to map", e);
            return new HashMap();
        }
    }
    ...
    public static JSONArray deepCopy(JSONArray jSONArray) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                C1240o.m3210l("JsonUtils", "Failed to copy over item at index " + i + " to JSONArray deep copy");
            }
        }
        return jSONArray2;
    }
