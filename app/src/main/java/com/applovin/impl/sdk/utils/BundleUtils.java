...
public class BundleUtils {
    ...
    public static void put(String str, Object obj, Bundle bundle) {
        if (obj == null) {
            C1240o.m3207h("AppLovinSdk", "Skipped insertion into Bundle because value is null.");
            return;
        }
        ...
        C1240o.m3207h("AppLovinSdk", "Skipped insertion of " + obj + " into Bundle");
    }
    ...
    public static JSONObject toJSONObject(Bundle bundle) throws JSONException {
        ...
        try {
            ...
            C1240o.m3204c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e);
        }
        return jSONObject;
    }
    ...
    public static boolean getBoolean(String str, boolean z, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            ...
            if (obj instanceof String) {
                ...
                if (str2.equalsIgnoreCase(C3401a.f9920g) || str2.equalsIgnoreCase("1")) {
                    return true;
                }
