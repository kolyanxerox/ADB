...
public final class Huffman {
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        OooOo.OooO0O0(children2);
        Arrays.fill(children2, i6, (1 << i5) + i6, node);
    }

    public final void decode(BufferedSource source, long j, BufferedSink sink) throws IOException {
