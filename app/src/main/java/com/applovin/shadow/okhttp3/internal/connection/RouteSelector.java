...
public final class RouteSelector {
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(InetSocketAddress inetSocketAddress) {
            OooOo.OooO0o0(inetSocketAddress, "<this>");
            InetAddress address = inetSocketAddress.getAddress();
            if (address == null) {
                String hostName = inetSocketAddress.getHostName();
                OooOo.OooO0Oo(hostName, "hostName");
                return hostName;
            }
            String hostAddress = address.getHostAddress();
            OooOo.OooO0Oo(hostAddress, "address.hostAddress");
            return hostAddress;
        }
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        ...
        OooOo.OooO0o0(routeDatabase, "routeDatabase");
        ...
        this.proxies = oo000oVar;
        this.inetSocketAddresses = oo000oVar;
    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            OooOo.OooO0Oo(proxyAddress, "proxyAddress");
        ...
        if (Util.canParseAsIpAddress(strHost)) {
            listLookup = o0OO0O0.OooOO0o(InetAddress.getByName(strHost));
        } else {
    ...
    private static final List<Proxy> resetNextProxy$selectProxies(Proxy proxy, HttpUrl httpUrl, RouteSelector routeSelector) {
        ...
        OooOo.OooO0Oo(proxiesOrNull, "proxiesOrNull");
    ...
    public final Selection next() throws IOException {
        ...
        if (arrayList.isEmpty()) {
            o00O0O.OooOo0o(this.postponedRoutes, arrayList);
