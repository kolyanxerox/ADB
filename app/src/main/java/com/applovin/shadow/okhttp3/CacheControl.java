...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public final Builder maxAge(int i, TimeUnit timeUnit) {
            ...
            if (i < 0) {
                throw new IllegalArgumentException(OooO0oO.OooOo.OooO0o(i, "maxAge < 0: ").toString());
            }
        ...
        public final Builder maxStale(int i, TimeUnit timeUnit) {
            OooOo.OooO0o0(timeUnit, "timeUnit");
            if (i < 0) {
                throw new IllegalArgumentException(OooO0oO.OooOo.OooO0o(i, "maxStale < 0: ").toString());
            }
        ...
        public final Builder minFresh(int i, TimeUnit timeUnit) {
            OooOo.OooO0o0(timeUnit, "timeUnit");
            if (i < 0) {
                throw new IllegalArgumentException(OooO0oO.OooOo.OooO0o(i, "minFresh < 0: ").toString());
            }
    ...
    public static final class Companion {
        ...
        private final int indexOfElement(String str, String str2, int i) {
            ...
            while (i < length) {
                if (o000000.Oooo0o0(str2, str.charAt(i))) {
                    return i;
                }
                i++;
            }
    ...
    public /* synthetic */ CacheControl(boolean z, boolean z2, int i, int i2, boolean z3, boolean z4, boolean z5, int i3, int i4, boolean z6, boolean z7, boolean z8, String str, OooOO0O oooOO0O) {
    ...
    public final boolean m13553deprecated_immutable() {
        return this.immutable;
    }

    /* renamed from: -deprecated_maxAgeSeconds, reason: not valid java name */
    public final int m13554deprecated_maxAgeSeconds() {
        return this.maxAgeSeconds;
    }

    /* renamed from: -deprecated_maxStaleSeconds, reason: not valid java name */
    public final int m13555deprecated_maxStaleSeconds() {
        return this.maxStaleSeconds;
    }

    /* renamed from: -deprecated_minFreshSeconds, reason: not valid java name */
    public final int m13556deprecated_minFreshSeconds() {
        return this.minFreshSeconds;
    }

    /* renamed from: -deprecated_mustRevalidate, reason: not valid java name */
    public final boolean m13557deprecated_mustRevalidate() {
        return this.mustRevalidate;
    }

    /* renamed from: -deprecated_noCache, reason: not valid java name */
    public final boolean m13558deprecated_noCache() {
        return this.noCache;
    }

    /* renamed from: -deprecated_noStore, reason: not valid java name */
    public final boolean m13559deprecated_noStore() {
        return this.noStore;
    }

    /* renamed from: -deprecated_noTransform, reason: not valid java name */
    public final boolean m13560deprecated_noTransform() {
        return this.noTransform;
    }

    /* renamed from: -deprecated_onlyIfCached, reason: not valid java name */
    public final boolean m13561deprecated_onlyIfCached() {
        return this.onlyIfCached;
    }

    /* renamed from: -deprecated_sMaxAgeSeconds, reason: not valid java name */
    public final int m13562deprecated_sMaxAgeSeconds() {
