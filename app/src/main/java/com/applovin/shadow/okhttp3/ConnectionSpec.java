...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            OooOo.OooO0Oo(enabledCipherSuites, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            OooOo.OooO0Oo(enabledProtocols, "sslSocket.enabledProtocols");
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, OooO00o.f31314OooOo0o);
        } else {
            tlsVersionsIntersection = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        OooOo.OooO0Oo(supportedCipherSuites, "supportedCipherSuites");
        int iIndexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z && iIndexOf != -1) {
            OooOo.OooO0Oo(cipherSuitesIntersection, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            OooOo.OooO0Oo(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        OooOo.OooO0Oo(tlsVersionsIntersection, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m13568deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m13569deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m13570deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final List<CipherSuite> cipherSuites() {
        ...
        return OooOo00.Oooo0o0(arrayList);
    }
    ...
    public final boolean isCompatible(SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), OooO00o.f31314OooOo0o)) {
            return false;
        }
    ...
    public String toString() {
        ...
        return androidx.datastore.preferences.protobuf.OooO00o.OooOOOO(sb, this.supportsTlsExtensions, ')');
    }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuites) {
            OooOo.OooO0o0(cipherSuites, "cipherSuites");
            if (!this.tls) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections");
            }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersions) {
            OooOo.OooO0o0(tlsVersions, "tlsVersions");
            if (!this.tls) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections");
            }
