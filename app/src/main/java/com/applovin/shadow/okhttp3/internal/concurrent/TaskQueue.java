...
public final class TaskQueue {
    ...
    public static final class AwaitIdleTask extends Task {
        ...
        public AwaitIdleTask() {
            super(OooOo.OooOOOo(new StringBuilder(), Util.okHttpName, " awaitIdle"), false);
    ...
    /* renamed from: com.applovin.shadow.okhttp3.internal.concurrent.TaskQueue$execute$1 */
    public static final class C13401 extends Task {
        final /* synthetic */ OooO0O0 $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C13401(String str, boolean z, OooO0O0 oooO0O0) {
            super(str, z);
            this.$block = oooO0O0;
        }
    ...
    /* renamed from: com.applovin.shadow.okhttp3.internal.concurrent.TaskQueue$schedule$2 */
    public static final class C13412 extends Task {
        final /* synthetic */ OooO0O0 $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C13412(String str, OooO0O0 oooO0O0) {
    ...
    public TaskQueue(TaskRunner taskRunner, String name) {
        kotlin.jvm.internal.OooOo.OooO0o0(taskRunner, "taskRunner");
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String name, long j, boolean z, OooO0O0 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        if ((i & 4) != 0) {
        ...
        taskQueue.schedule(new C13401(name, z, block), j);
    }
    ...
    public final boolean cancelAllAndDecide$okhttp() {
        ...
        if (task != null) {
            kotlin.jvm.internal.OooOo.OooO0O0(task);
    ...
    public final void execute(String name, long j, boolean z, OooO0O0 block) {
        kotlin.jvm.internal.OooOo.OooO0o0(name, "name");
        kotlin.jvm.internal.OooOo.OooO0o0(block, "block");
        schedule(new C13401(name, z, block), j);
    }
    ...
    public final List<Task> getScheduledTasks() {
        List<Task> listOooo0o0;
        synchronized (this.taskRunner) {
            listOooo0o0 = OooOo00.Oooo0o0(this.futureTasks);
        }
        return listOooo0o0;
    }
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String name, long j, OooO0O0 block, int i, Object obj) {
        if ((i & 2) != 0) {
            j = 0;
        }
        kotlin.jvm.internal.OooOo.OooO0o0(name, "name");
        kotlin.jvm.internal.OooOo.OooO0o0(block, "block");
        taskQueue.schedule(new C13412(name, block), j);
    }

    public final void schedule(String name, long j, OooO0O0 block) {
        kotlin.jvm.internal.OooOo.OooO0o0(name, "name");
        kotlin.jvm.internal.OooOo.OooO0o0(block, "block");
        schedule(new C13412(name, block), j);
    }
}
