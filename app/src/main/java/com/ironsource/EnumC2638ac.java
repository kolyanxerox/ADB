...
import com.ironsource.InterfaceC3826x6;
...
/* renamed from: com.ironsource.ac */
/* loaded from: classes2.dex */
public enum EnumC2638ac {
    FIRST_INSTANCE(14),
    ...
    RV_INSTANCE_LOAD_FAILED(InterfaceC3018cs.c.f7824d),
    RV_INSTANCE_SHOW(InterfaceC3018cs.a.f7810b),
    RV_INSTANCE_SHOW_FAILED(InterfaceC3018cs.a.f7811c),
    RV_INSTANCE_CLOSED(InterfaceC3018cs.a.f7815g),
    RV_INSTANCE_STARTED(1204),
    RV_INSTANCE_ENDED(1205),
    RV_INSTANCE_VISIBLE(InterfaceC3018cs.a.f7813e),
    RV_INSTANCE_AVAILABILITY_TRUE(1207),
    RV_INSTANCE_AVAILABILITY_FALSE(1208),
    RV_INSTANCE_SHOW_CHANCE(1209),
    RV_INSTANCE_READY_TRUE(InterfaceC3018cs.a.f7818j),
    RV_INSTANCE_READY_FALSE(InterfaceC3018cs.a.f7819k),
    RV_INSTANCE_LOAD_FAILED_REASON(1212),
    RV_INSTANCE_LOAD_NO_FILL(1213),
    RV_MEDIATION_LOAD_ERROR(1220),
    RV_AUCTION_REQUEST(1300),
    RV_AUCTION_FAILED(InterfaceC3018cs.c.f7825e),
    ...
    RV_CAP_SESSION(1401),
    RV_DO_INSTANCE_NOT_FOUND_IN_AVAILABILITY_CHECK(o000Oo0.DRIVE_EXTERNAL_STORAGE_REQUIRED),
    RV_DO_BUSINESS_INSTANCE_NOT_FOUND_IN_LOAD(InterfaceC3018cs.c.f7826f),
    RV_DO_BUSINESS_INSTANCE_NOT_FOUND_IN_SHOW(InterfaceC3018cs.a.f7816h),
    ...
    IS_LOAD_CALLED(2001),
    IS_INSTANCE_LOAD(InterfaceC3771vj.b.f12380b),
    IS_INSTANCE_LOAD_SUCCESS(InterfaceC3771vj.b.f12381c),
    IS_CALLBACK_LOAD_SUCCESS(2004),
    IS_INSTANCE_OPENED(InterfaceC3771vj.a.f12372d),
    IS_INSTANCE_CLICKED(InterfaceC3771vj.a.f12374f),
    ...
    IS_INSTANCE_LOAD_FAILED(InterfaceC3771vj.b.f12382d),
    IS_INSTANCE_SHOW(InterfaceC3771vj.a.f12370b),
    IS_INSTANCE_SHOW_SUCCESS(2202),
    IS_INSTANCE_SHOW_FAILED(InterfaceC3771vj.a.f12371c),
    IS_INSTANCE_CLOSED(InterfaceC3771vj.a.f12375g),
    IS_INSTANCE_INIT_SUCCESS(2205),
    IS_INSTANCE_INIT_FAILED(2206),
    IS_INSTANCE_VISIBLE(InterfaceC3771vj.a.f12373e),
    IS_INSTANCE_READY_TRUE(InterfaceC3771vj.a.f12377i),
    IS_INSTANCE_READY_FALSE(InterfaceC3771vj.a.f12378j),
    IS_INSTANCE_LOAD_NO_FILL(2213),
    IS_AUCTION_FAILED(InterfaceC3771vj.b.f12385g),
    IS_AUCTION_SUCCESS(2301),
    IS_AD_FORMAT_CAPPED(InterfaceC3374e.a.f9708k),
    ...
    IS_DO_INSTANCE_NOT_FOUND_IN_LOAD(InterfaceC3771vj.b.f12383e),
    IS_DO_INSTANCE_NOT_FOUND_IN_SHOW(InterfaceC3771vj.a.f12376h),
    ...
    BN_INSTANCE_LEAVE_APP(InterfaceC3371b.b.f9670g),
    BN_INSTANCE_DESTROY(3305),
    BN_INSTANCE_LOAD_NO_FILL(InterfaceC3371b.b.f9672i),
    ...
    BN_DO_INSTANCE_NOT_FOUND_IN_LOAD(InterfaceC3826x6.b.f12582e),
    ...
    TROUBLESHOOT_RV_INSTANCE_LOAD_WITH_ADM(InterfaceC3018cs.e.f7833f),
    ...
    TROUBLESHOOT_RV_INSTANCE_AUCTION_FAILED(InterfaceC3018cs.e.f7832e),
    TROUBLESHOOT_RV_INSTANCE_AUCTION_SUCCESS(InterfaceC3018cs.e.f7831d),
    TROUBLESHOOT_RV_INSTANCE_AUCTION_RESPONSE_WATERFALL(InterfaceC3018cs.e.f7836i),
    ...
    TROUBLESHOOT_RV_INSTANCE_AUCTION_REQUEST(InterfaceC3018cs.e.f7829b),
    TROUBLESHOOT_RV_INSTANCE_AUCTION_REQUEST_WATERFALL(InterfaceC3018cs.e.f7830c),
    TROUBLESHOOTING_IS_LOAD(82001),
    TROUBLESHOOTING_IS_INSTANCE_LOAD_WITH_ADM(InterfaceC3771vj.d.f12390e),
    ...
    TROUBLESHOOTING_IS_INSTANCE_AUCTION_FAILED(InterfaceC3771vj.d.f12389d),
    TROUBLESHOOTING_IS_INSTANCE_AUCTION_SUCCESS(InterfaceC3771vj.d.f12393h),
    TROUBLESHOOTING_IS_INSTANCE_AUCTION_RESPONSE_WATERFALL(InterfaceC3771vj.d.f12394i),
    ...
    TROUBLESHOOTING_IS_INSTANCE_AUCTION_REQUEST(InterfaceC3771vj.d.f12387b),
    TROUBLESHOOTING_IS_INSTANCE_AUCTION_REQUEST_WATERFALL(InterfaceC3771vj.d.f12388c),
    TROUBLESHOOTING_DO_IAB_RV_LOAD_FAILED_INIT_IN_PROGRESS(83002),
    TROUBLESHOOTING_DO_IAB_IS_LOAD_FAILED_INIT_IN_PROGRESS(InterfaceC3018cs.e.f7835h),
