...
public class MetaDataUtils {
    ...
    public static String formatValueForType(String str, MetaData.MetaDataValueTypes metaDataValueTypes) {
        ...
        String str2 = C3401a.f9920g;
        if (!str.equalsIgnoreCase(C3401a.f9920g) && !str.equalsIgnoreCase("yes")) {
            str2 = "false";
    ...
    public static MetaData.MetaDataValueTypes getValueTypeForKey(String str) {
        return (str.equalsIgnoreCase(C3401a.f9914a) || str.equalsIgnoreCase(C3401a.f9915b) || str.equalsIgnoreCase(C3401a.f9916c) || str.equalsIgnoreCase(C3401a.f9917d)) ? MetaData.MetaDataValueTypes.META_DATA_VALUE_BOOLEAN : MetaData.MetaDataValueTypes.META_DATA_VALUE_STRING;
    }

    public static boolean isKnownKey(String str) {
        return C3401a.f9926m.contains(str.toLowerCase(Locale.getDefault()));
    }

    public static boolean isMediationKeysBeforeInit(String str) {
        return C3401a.f9925l.contains(str.toLowerCase(Locale.getDefault()));
    }

    public static boolean isMediationOnlyKey(String str) {
        return C3401a.f9924k.contains(str.toLowerCase(Locale.getDefault()));
    }

    public static boolean isValidCCPAMetaData(String str, String str2) {
        return isValidMetaData(str, C3401a.f9914a, str2);
    }
