...
public class IronSourceAES {
    /* renamed from: a */
    private static SecretKeySpec m10694a(String str) throws UnsupportedEncodingException {
    ...
    public static synchronized String compressAndEncrypt(String str) {
        return compressAndEncrypt(C3359mb.m10015b().m10017c(), str);
    }
    ...
    public static synchronized byte[] decodeToBytes(String str, String str2) {
        ...
        try {
            SecretKeySpec secretKeySpecM10694a = m10694a(str);
            byte[] bArr = new byte[16];
            Arrays.fill(bArr, (byte) 0);
            IvParameterSpec ivParameterSpec = new IvParameterSpec(bArr);
            byte[] bArrDecode = Base64.decode(str2, 0);
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
            cipher.init(2, secretKeySpecM10694a, ivParameterSpec);
    ...
    public static synchronized String decryptAndDecompress(String str) {
        return decryptAndDecompress(C3359mb.m10015b().m10017c(), str);
    }
    ...
    public static synchronized String encodeFromBytes(String str, byte[] bArr) {
        ...
        try {
            ...
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
            cipher.init(1, secretKeySpecM10694a, ivParameterSpec);
    ...
    public static synchronized String encrypt(String str) {
        return encode(C3359mb.m10015b().m10017c(), str);
    }
    ...
    public static synchronized String compressAndEncrypt(String str, String str2) {
        ...
        try {
            byte[] bArrM8712a = C3120fk.m8712a(str2);
            if (bArrM8712a != null) {
                return encodeFromBytes(str, bArrM8712a);
            }
        } catch (Exception e) {
            C3551q9.m11517d().m11519a(e);
            IronLog.INTERNAL.error(e.toString());
    ...
    public static synchronized String decryptAndDecompress(String str, String str2) {
        ...
        try {
            byte[] bArrDecodeToBytes = decodeToBytes(str, str2);
            if (bArrDecodeToBytes != null) {
                return C3120fk.m8711a(bArrDecodeToBytes);
            }
        } catch (Exception e) {
            C3551q9.m11517d().m11519a(e);
            IronLog.INTERNAL.error(e.toString());
