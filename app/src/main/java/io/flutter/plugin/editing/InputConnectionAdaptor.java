...
public class InputConnectionAdaptor extends BaseInputConnection implements ListenableEditingState.EditingStateWatcher {
    ...
    private static int clampIndexToEditable(int i, Editable editable) {
        ...
        if (iMax != i) {
            Log.m13457d("flutter", OooOo.OooO("Text selection index was clamped (", i, "->", iMax, ") to remain in bounds. This may not be your fault, as some keyboards may select outside of bounds."));
        }
        return iMax;
    }
    ...
    private boolean handleHorizontalMovement(boolean z, boolean z2) {
        ...
        int iMax = z ? Math.max(this.flutterTextUtils.getOffsetBefore(this.mEditable, selectionEnd), 0) : Math.min(this.flutterTextUtils.getOffsetAfter(this.mEditable, selectionEnd), this.mEditable.length());
    ...
    public boolean performEditorAction(int i) {
        if (i == 0) {
            ...
            this.textInputChannel.m13468go(this.mClient);
        } else if (i == 3) {
    ...
    public boolean requestCursorUpdates(int i) {
        ...
        if (z != this.mMonitorCursorUpdate) {
            Log.m13457d(TAG, "The input method toggled cursor monitoring ".concat(z ? "on" : "off"));
        }
    ...
    public ExtractedText getExtractedText(ExtractedTextRequest extractedTextRequest, int i) {
        ...
        if (z == (this.mExtractRequest == null)) {
            Log.m13457d(TAG, "The input method toggled text monitoring ".concat(z ? "on" : "off"));
        }
