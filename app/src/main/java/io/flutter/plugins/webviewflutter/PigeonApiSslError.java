...
public abstract class PigeonApiSslError {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.OooOo.OooO0OO(obj2, "null cannot be cast to non-null type android.net.http.SslError");
            try {
                listWrapError = o0OO0O0.OooOO0o(pigeonApiSslError.getPrimaryError((SslError) obj2));
            } catch (Throwable th) {
        ...
        public static final void setUpMessageHandlers$lambda$3$lambda$2(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.OooOo.OooO0OO(obj3, "null cannot be cast to non-null type io.flutter.plugins.webviewflutter.SslErrorType");
            try {
                listWrapError = o0OO0O0.OooOO0o(Boolean.valueOf(pigeonApiSslError.hasError(sslError, (SslErrorType) obj3)));
            } catch (Throwable th) {
                listWrapError = AndroidWebkitLibraryPigeonUtils.INSTANCE.wrapError(th);
            }
            reply.reply(listWrapError);
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, final PigeonApiSslError pigeonApiSslError) {
            ...
            if (pigeonApiSslError != null) {
                final int i = 0;
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.oo000o
            ...
            if (pigeonApiSslError == null) {
                ...
                final int i2 = 1;
                basicMessageChannel2.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.oo000o
                    @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        switch (i2) {
                            case 0:
    ...
    public final void pigeon_newInstance(SslError pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.SslError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(o00O0.OooOo.OooOOo(Long.valueOf(jAddHostCreatedInstance), certificate(pigeon_instanceArg), url(pigeon_instanceArg)), new OooO0O0(17, callback));
    }
