...
public abstract class PigeonApiJavaScriptChannel {
    ...
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiJavaScriptChannel pigeonApiJavaScriptChannel) {
            ...
            if (pigeonApiJavaScriptChannel != null) {
                basicMessageChannel.setMessageHandler(new OooOo00(pigeonApiJavaScriptChannel, 5));
            } else {
    ...
    public static final void postMessage$lambda$0(o00O0Oo.Oooo000 oooo000, String str, Object obj) {
    ...
    public final void pigeon_newInstance(JavaScriptChannel pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            AbstractC2183w4.OooOOoo(AbstractC2183w4.OooOOOO("new-instance-error", "Attempting to create a new Dart instance of JavaScriptChannel, but the class has a nonnull callback method.", ""), callback);
        }
    }

    public final void postMessage(JavaScriptChannel pigeon_instanceArg, String messageArg, o00O0Oo.Oooo000 callback) {
        kotlin.jvm.internal.OooOo.OooO0o0(pigeon_instanceArg, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.JavaScriptChannel.postMessage", getPigeonRegistrar().getCodec()).send(o00O0.OooOo.OooOOo(pigeon_instanceArg, messageArg), new OooO0O0(12, callback));
        }
    }
}
