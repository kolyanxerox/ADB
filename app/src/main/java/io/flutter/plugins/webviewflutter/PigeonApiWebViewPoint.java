...
public abstract class PigeonApiWebViewPoint {
    ...
    public final void pigeon_newInstance(WebViewPoint pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(o00O0.OooOo.OooOOo(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg)), Long.valueOf(mo13469x(pigeon_instanceArg)), Long.valueOf(mo13470y(pigeon_instanceArg))), new o0OOO0o(29, callback));
    }

    /* renamed from: x */
    public abstract long mo13469x(WebViewPoint webViewPoint);

    /* renamed from: y */
    public abstract long mo13470y(WebViewPoint webViewPoint);
}
