...
public abstract class PigeonApiWebResourceError {
    ...
    @RequiresApi(api = 23)
    public final void pigeon_newInstance(WebResourceError pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(o00O0.OooOo.OooOOo(Long.valueOf(jAddHostCreatedInstance), Long.valueOf(jErrorCode), description(pigeon_instanceArg)), new o0OOO0o(1, callback));
    }
}
