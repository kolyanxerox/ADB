...
public abstract class PigeonApiCustomViewCallback {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiCustomViewCallback pigeonApiCustomViewCallback, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.OooOo.OooO0OO(obj2, "null cannot be cast to non-null type android.webkit.WebChromeClient.CustomViewCallback");
            try {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiCustomViewCallback pigeonApiCustomViewCallback) {
            ...
            if (pigeonApiCustomViewCallback != null) {
                basicMessageChannel.setMessageHandler(new OooOo00(pigeonApiCustomViewCallback, 2));
            } else {
    ...
    public final void pigeon_newInstance(WebChromeClient.CustomViewCallback pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(o0OO0O0.OooOO0o(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new OooO0O0(6, callback));
        }
    }
}
