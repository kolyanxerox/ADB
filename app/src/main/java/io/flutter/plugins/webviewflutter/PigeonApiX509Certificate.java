...
public class PigeonApiX509Certificate {
    ...
    public final void pigeon_newInstance(X509Certificate pigeon_instanceArg, o00O0Oo.Oooo000 callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.X509Certificate.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(o0OO0O0.OooOO0o(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new o000000(0, callback));
        }
    }
}
