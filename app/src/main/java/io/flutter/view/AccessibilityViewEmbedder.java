...
class AccessibilityViewEmbedder {
    ...
    public static class ReflectionAccessors {
        ...
        public Long getChildId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo, int i) {
            ...
            if (method != null) {
                try {
                    ...
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "Failed to access getChildId method.", e);
                } catch (InvocationTargetException e2) {
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "The getChildId method threw an exception when invoked.", e2);
                }
            } else {
                try {
                    ...
                    e = e3;
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "The longArrayGetIndex method threw an exception when invoked.", e);
                    return null;
                } catch (IllegalAccessException e4) {
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "Failed to access longArrayGetIndex method or the childNodeId field.", e4);
        ...
        public Long getParentNodeId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (method != null) {
                try {
                    ...
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "Failed to access getParentNodeId method.", e);
                } catch (InvocationTargetException e2) {
                    Log.m13466w(AccessibilityViewEmbedder.TAG, "The getParentNodeId method threw an exception when invoked.", e2);
                }
            }
        ...
        public Long getRecordSourceNodeId(@NonNull AccessibilityRecord accessibilityRecord) {
            ...
            try {
                ...
                Log.m13466w(AccessibilityViewEmbedder.TAG, "Failed to access the getRecordSourceNodeId method.", e);
                return null;
            } catch (InvocationTargetException e2) {
                Log.m13466w(AccessibilityViewEmbedder.TAG, "The getRecordSourceNodeId method threw an exception when invoked.", e2);
                return null;
            }
        }
        ...
        public Long getSourceNodeId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            try {
                ...
                Log.m13466w(AccessibilityViewEmbedder.TAG, "Failed to access getSourceNodeId method.", e);
                return null;
            } catch (InvocationTargetException e2) {
                Log.m13466w(AccessibilityViewEmbedder.TAG, "The getSourceNodeId method threw an exception when invoked.", e2);
                return null;
            }
        }
        ...
        private static Long yoinkParentIdFromParcel(AccessibilityNodeInfo accessibilityNodeInfo) {
            if (Build.VERSION.SDK_INT < 26) {
                Log.m13465w(AccessibilityViewEmbedder.TAG, "Unexpected Android version. Unable to find the parent ID.");
                return null;
            }
        ...
        private ReflectionAccessors() throws NoSuchFieldException, NoSuchMethodException, SecurityException {
            ...
            try {
                ...
                Log.m13465w(AccessibilityViewEmbedder.TAG, "can't invoke AccessibilityNodeInfo#getSourceNodeId with reflection");
                method = null;
            }
            try {
                method2 = AccessibilityRecord.class.getMethod("getSourceNodeId", null);
            } catch (NoSuchMethodException unused2) {
                Log.m13465w(AccessibilityViewEmbedder.TAG, "can't invoke AccessibiiltyRecord#getSourceNodeId with reflection");
                method2 = null;
            }
            ...
            if (i > 26) {
                try {
                    ...
                    Log.m13465w(AccessibilityViewEmbedder.TAG, "can't access childNodeIdsField with reflection");
                    method4 = null;
                    field = null;
                }
            ...
            try {
                ...
                Log.m13465w(AccessibilityViewEmbedder.TAG, "can't invoke getParentNodeId with reflection");
                method3 = null;
            }
            try {
                ...
                Log.m13465w(AccessibilityViewEmbedder.TAG, "can't invoke getChildId with reflection");
                method4 = null;
                field = null;
            }
            method6 = method3;
    ...
    public static class ViewAndId {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f13229id == viewAndId.f13229id && this.view.equals(viewAndId.view);
        }

        public int hashCode() {
            return ((this.view.hashCode() + 31) * 31) + this.f13229id;
        }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (viewAndId == null || !this.embeddedViewToDisplayBounds.containsKey(viewAndId.view) || viewAndId.view.getAccessibilityNodeProvider() == null || (accessibilityNodeInfoCreateAccessibilityNodeInfo = viewAndId.view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(viewAndId.f13229id)) == null) {
            return null;
        }
    ...
    public boolean performAction(int i, int i2, @Nullable Bundle bundle) {
        ...
        return accessibilityNodeProvider.performAction(viewAndId.f13229id, i2, bundle);
    }
