    ...
    public FlutterTextureView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: io.flutter.embedding.android.FlutterTextureView.1
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
                Log.m13463v(FlutterTextureView.TAG, "SurfaceTextureListener.onSurfaceTextureAvailable()");
            ...
            public boolean onSurfaceTextureDestroyed(@NonNull SurfaceTexture surfaceTexture) {
                Log.m13463v(FlutterTextureView.TAG, "SurfaceTextureListener.onSurfaceTextureDestroyed()");
            ...
            public void onSurfaceTextureSizeChanged(@NonNull SurfaceTexture surfaceTexture, int i, int i2) {
                Log.m13463v(FlutterTextureView.TAG, "SurfaceTextureListener.onSurfaceTextureSizeChanged()");
                if (FlutterTextureView.this.shouldNotify()) {
