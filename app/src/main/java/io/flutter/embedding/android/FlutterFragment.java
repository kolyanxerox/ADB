...
public class FlutterFragment extends Fragment implements FlutterActivityAndFragmentDelegate.Host, ComponentCallbacks2, FlutterActivityAndFragmentDelegate.DelegateFactory {
    ...
    public static class NewEngineInGroupFragmentBuilder {
        ...
        public NewEngineInGroupFragmentBuilder(@NonNull Class<? extends FlutterFragment> cls, @NonNull String str) {
            this.dartEntrypoint = C3034d9.h.f8093Z;
            this.initialRoute = "/";
            this.handleDeeplinking = false;
            this.renderMode = RenderMode.surface;
            this.transparencyMode = TransparencyMode.transparent;
    ...
    public boolean stillAttachedForEvent(String str) {
        ...
        if (flutterActivityAndFragmentDelegate == null) {
            Log.m13465w(TAG, "FlutterFragment " + hashCode() + StringUtils.SPACE + str + " called after release.");
            return false;
        }
        if (flutterActivityAndFragmentDelegate.isAttached()) {
            return true;
        }
        Log.m13465w(TAG, "FlutterFragment " + hashCode() + StringUtils.SPACE + str + " called after detach.");
        return false;
    }
    ...
    public void detachFromFlutterEngine() {
        Log.m13465w(TAG, "FlutterFragment " + this + " connection to the engine " + getFlutterEngine() + " evicted by another attaching activity");
        FlutterActivityAndFragmentDelegate flutterActivityAndFragmentDelegate = this.delegate;
        if (flutterActivityAndFragmentDelegate != null) {
    ...
    public String getDartEntrypointFunctionName() {
        return getArguments().getString(ARG_DART_ENTRYPOINT, C3034d9.h.f8093Z);
    }
    ...
    public void onDetach() {
        ...
        if (flutterActivityAndFragmentDelegate != null) {
            ...
            Log.m13463v(TAG, "FlutterFragment " + this + " onDetach called after release.");
        }
    }
    ...
    public void onPause() {
        super.onPause();
        if (stillAttachedForEvent(C3034d9.h.f8132t0)) {
    ...
    public void onResume() {
        super.onResume();
        if (stillAttachedForEvent(C3034d9.h.f8134u0)) {
    ...
    public FlutterEngine provideFlutterEngine(@NonNull Context context) {
        ...
        Log.m13463v(TAG, "Deferring to attached Activity to provide a FlutterEngine.");
