...
public class DartExecutor implements BinaryMessenger {
    ...
    public class C43961 implements BinaryMessenger.BinaryMessageHandler {
        public C43961() {
        }
    ...
    public static class DartCallback {
        ...
        public String toString() {
            ...
            sb.append(", function: ");
            return OooOo.OooOOOo(sb, this.callbackHandle.callbackName, " )");
        }
    }
    ...
    public static class DefaultBinaryMessenger implements BinaryMessenger {
        ...
        public /* synthetic */ DefaultBinaryMessenger(DartMessenger dartMessenger, C43961 c43961) {
            this(dartMessenger);
        }
    ...
    public void executeDartCallback(@NonNull DartCallback dartCallback) {
        if (this.isApplicationRunning) {
            Log.m13465w(TAG, "Attempted to run a DartExecutor that is already running.");
            return;
        }
        TraceSection traceSectionScoped = TraceSection.scoped("DartExecutor#executeDartCallback");
        try {
            Log.m13463v(TAG, "Executing Dart callback: " + dartCallback);
    ...
    public void onAttachedToJNI() {
        Log.m13463v(TAG, "Attached to JNI. Registering the platform message handler for this Dart execution context.");
        this.flutterJNI.setPlatformMessageHandler(this.dartMessenger);
    }

    public void onDetachedFromJNI() {
        Log.m13463v(TAG, "Detached from JNI. De-registering the platform message handler for this Dart execution context.");
    ...
    public DartExecutor(@NonNull FlutterJNI flutterJNI, @NonNull AssetManager assetManager, long j) {
        ...
        C43961 c43961 = new BinaryMessenger.BinaryMessageHandler() { // from class: io.flutter.embedding.engine.dart.DartExecutor.1
            public C43961() {
            }
        ...
        this.isolateChannelMessageHandler = c43961;
        this.flutterJNI = flutterJNI;
        this.assetManager = assetManager;
        this.engineId = j;
        DartMessenger dartMessenger = new DartMessenger(flutterJNI);
        this.dartMessenger = dartMessenger;
        dartMessenger.setMessageHandler("flutter/isolate", c43961);
    ...
    public void executeDartEntrypoint(@NonNull DartEntrypoint dartEntrypoint, @Nullable List<String> list) {
        ...
        try {
            Log.m13463v(TAG, "Executing Dart entrypoint: " + dartEntrypoint);
    ...
    public static class DartEntrypoint {
        ...
        public static DartEntrypoint createDefault() {
            ...
            if (flutterLoader.initialized()) {
                return new DartEntrypoint(flutterLoader.findAppBundlePath(), C3034d9.h.f8093Z);
            }
        ...
        public String toString() {
            ...
            sb.append(this.pathToBundle);
            sb.append(", function: ");
            return OooOo.OooOOOo(sb, this.dartEntrypointFunctionName, " )");
        }
