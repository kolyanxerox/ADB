...
public class FlutterLoader {
    ...
    public class CallableC43991 implements Callable<InitResult> {
        final /* synthetic */ Context val$appContext;

        public CallableC43991(Context context) {
        ...
        public InitResult call() throws Throwable {
            ...
            try {
                ...
                try {
                    ...
                    FlutterLoader.this.executorService.execute(new Runnable() { // from class: io.flutter.embedding.engine.loader.OooO0O0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f28707OooOo0O.lambda$call$0();
                        }
                    });
                    ...
                    while (i < length) {
                        ...
                        if (strArr2 != null) {
                            ...
                            while (i2 < length2) {
                                ...
                                try {
                                    arrayList2.add(strArr2[i2] + string);
                                    i2++;
    ...
    public static class InitResult {
        ...
        public /* synthetic */ InitResult(String str, String str2, String str3, CallableC43991 callableC43991) {
            this(str, str2, str3);
        }
    ...
    private String fullAssetPathFrom(@NonNull String str) {
        ...
        return OooOo.OooOOOo(sb, File.separator, str);
    }
    ...
    public /* synthetic */ void lambda$ensureInitializationCompleteAsync$0(Context context, String[] strArr, Handler handler, Runnable runnable) throws Throwable {
        ensureInitializationComplete(context.getApplicationContext(), strArr);
        handler.post(runnable);
    }

    public /* synthetic */ void lambda$ensureInitializationCompleteAsync$1(Context context, String[] strArr, Handler handler, Runnable runnable) throws ExecutionException, InterruptedException {
        try {
            this.initResultFuture.get();
            HandlerCompat.createAsyncHandler(Looper.getMainLooper()).post(new OooO00o(this, context, strArr, handler, runnable, 1));
        } catch (Exception e) {
            Log.m13460e(TAG, "Flutter initialization failed.", e);
    ...
    public void ensureInitializationComplete(@NonNull Context context, @Nullable String[] strArr) throws Throwable {
        TraceSection traceSection;
        ...
        try {
            ...
            try {
                initResult = this.initResultFuture.get();
            ...
            try {
                ...
                arrayList.add("--leak-vm=".concat(isLeakVM(bundle) ? C3401a.f9920g : "false"));
    ...
    public void ensureInitializationCompleteAsync(@NonNull Context context, @Nullable String[] strArr, @NonNull Handler handler, @NonNull Runnable runnable) {
        ...
        if (this.initialized) {
            ...
            this.executorService.execute(new OooO00o(this, context, strArr, handler, runnable, 0));
        }
    }
    ...
    public String getLookupKeyForAsset(@NonNull String str, @NonNull String str2) {
        ...
        return getLookupKeyForAsset(androidx.datastore.preferences.protobuf.OooO00o.OooOOO(sb, str3, str2, str3, str));
    }
    ...
    public void startInitialization(@NonNull Context context, @NonNull Settings settings) {
        ...
        try {
            ...
            VsyncWaiter.getInstance((DisplayManager) applicationContext.getSystemService(C3034d9.h.f8099d), this.flutterJNI).init();
            this.initResultFuture = this.executorService.submit(new CallableC43991(applicationContext));
            if (traceSectionScoped != null) {
                traceSectionScoped.close();
            }
        } catch (Throwable th) {
