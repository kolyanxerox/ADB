...
public final class ApplicationInfoLoader {
    ...
    private static String getNetworkPolicy(ApplicationInfo applicationInfo, Context context) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int i;
    ...
    private static void parseDomainConfig(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlResourceParser.getName().equals(C3034d9.i.f8149D)) {
