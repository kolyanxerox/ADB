...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
    ...
    /* renamed from: io.flutter.embedding.engine.FlutterEngine$1 */
    public class C43931 implements EngineLifecycleListener {
        public C43931() {
        }
        ...
        public void onPreEngineRestart() {
            Log.m13463v(FlutterEngine.TAG, "onPreEngineRestart()");
    ...
    private void attachToJni() {
        Log.m13463v(TAG, "Attaching to JNI.");
    ...
    @VisibleForTesting(otherwise = 3)
    public FlutterEngine(@NonNull Context context, @Nullable FlutterLoader flutterLoader, @NonNull FlutterJNI flutterJNI, @NonNull PlatformViewsController platformViewsController, @Nullable String[] strArr, boolean z, boolean z2, @Nullable FlutterEngineGroup flutterEngineGroup) throws Throwable {
        AssetManager assets;
