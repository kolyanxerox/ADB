        ...
        MethodChannel.MethodCallHandler methodCallHandler = new MethodChannel.MethodCallHandler() { // from class: io.flutter.embedding.engine.systemchannels.PlatformViewsChannel2.1
            private void clearFocus(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                try {
                    ...
                    result.error(C3912zo.a.f13038g, PlatformViewsChannel2.detailedExceptionString(e), null);
                }
            }
            ...
            private void create(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                ...
                try {
                    PlatformViewsChannel2.this.handler.createPlatformView(new PlatformViewCreationRequest(((Integer) map.get(C3007ch.f7763x)).intValue(), (String) map.get("viewType"), 0.0d, 0.0d, ((Integer) map.get("direction")).intValue(), map.containsKey("params") ? ByteBuffer.wrap((byte[]) map.get("params")) : null));
                    result.success(null);
                } catch (IllegalStateException e) {
                    result.error(C3912zo.a.f13038g, PlatformViewsChannel2.detailedExceptionString(e), null);
                }
            ...
            private void dispose(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                try {
                    PlatformViewsChannel2.this.handler.dispose(((Integer) ((Map) methodCall.arguments()).get(C3007ch.f7763x)).intValue());
                    result.success(null);
                } catch (IllegalStateException e) {
                    result.error(C3912zo.a.f13038g, PlatformViewsChannel2.detailedExceptionString(e), null);
                }
            ...
            private void setDirection(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                Map map = (Map) methodCall.arguments();
                try {
                    PlatformViewsChannel2.this.handler.setDirection(((Integer) map.get(C3007ch.f7763x)).intValue(), ((Integer) map.get("direction")).intValue());
                    result.success(null);
                } catch (IllegalStateException e) {
                    result.error(C3912zo.a.f13038g, PlatformViewsChannel2.detailedExceptionString(e), null);
                }
            ...
            public void onMethodCall(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                ...
                Log.m13463v(PlatformViewsChannel2.TAG, "Received '" + methodCall.method + "' message.");
