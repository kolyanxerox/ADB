...
public class FlutterEngineGroup {
    ...
    public class C43951 implements FlutterEngine.EngineLifecycleListener {
        final /* synthetic */ FlutterEngine val$engineToCleanUpOnDestroy;

        public C43951(FlutterEngine flutterEngine) {
    ...
    public FlutterEngineGroup(@NonNull Context context, @Nullable String[] strArr) throws Throwable {
    ...
    public FlutterEngine createAndRunEngine(@NonNull Options options) {
        FlutterEngine flutterEngineSpawn;
        ...
        flutterEngineSpawn.addEngineLifecycleListener(new FlutterEngine.EngineLifecycleListener() { // from class: io.flutter.embedding.engine.FlutterEngineGroup.1
            ...
            public C43951(FlutterEngine flutterEngineSpawn2) {
                flutterEngine = flutterEngineSpawn2;
            }
