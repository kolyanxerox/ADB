...
public class NavigationChannel {
    ...
    public void setInitialRoute(@NonNull String str) {
        Log.m13463v(TAG, "Sending message to set initial route to '" + str + "'");
